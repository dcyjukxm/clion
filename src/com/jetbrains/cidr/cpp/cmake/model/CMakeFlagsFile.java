...
class CMakeFlagsFile
{
    public static final String AD_HOC_TARGET_FLAGS = "_AD_HOC_TARGET_FLAGS_";
    private final Map<String, String> myVariables;
    
    CMakeFlagsFile(@NotNull final String s) throws CMakeException {
        if (s == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "text", "com/jetbrains/cidr/cpp/cmake/model/CMakeFlagsFile", "<init>"));
        }
        this.myVariables = Collections.unmodifiableMap((Map<? extends String, ? extends String>)new Parser().parseUnique(s));
    }
    
    CMakeFlagsFile(@NotNull final File file, @NotNull final String s) throws CMakeException {
        if (file == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "file", "com/jetbrains/cidr/cpp/cmake/model/CMakeFlagsFile", "<init>"));
        }
        if (s == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "encoding", "com/jetbrains/cidr/cpp/cmake/model/CMakeFlagsFile", "<init>"));
        }
        this.myVariables = Collections.unmodifiableMap((Map<? extends String, ? extends String>)new Parser().parseUnique(file, s));
    }
    ...
    public Collection<String> getVariables() {
        ...
        try {
            ...
            if (values == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeFlagsFile", "getVariables"));
            }
        }
    ...
    @Nullable
    public String getVariable(@NotNull final String s) {
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "key", "com/jetbrains/cidr/cpp/cmake/model/CMakeFlagsFile", "getVariable"));
            }
        }
        catch (IllegalArgumentException ex) {
            throw a(ex);
