...
public class CMakeGenerator
{
    ...
    private static final Pattern CMAKE_COMPILER_FILE_PATTERN;
    private static List<String> ourEmulateCMakeExecutionErrorInDebugConfig;
    @Nullable
    private static List<Pair<String, String>> ourEmulateProductNotFoundForTargetAndConfig;
    @NotNull
    ...
    public static void setEmulateCMakeExecutionErrorInTests(@Nullable final String... array) {
        ...
        CMakeGenerator.ourEmulateCMakeExecutionErrorInDebugConfig = list;
    }
    
    @SafeVarargs
    public static void setEmulateProductNotFoundInTests(@Nullable final Pair<String, String>... array) {
        ...
        Label_0028: {
            Label_0016: {
                try {
                    ...
                    final Pair<String, String>[] array2 = array;
                    final int n = array2.length;
                    if (n == 0) {
                        break Label_0016;
                    }
        ...
        CMakeGenerator.ourEmulateProductNotFoundForTargetAndConfig = list;
    }
    
    public CMakeGenerator(@NotNull final Project myProject, @NotNull final File file, @NotNull final List<Parameters> myParameters, @Nullable final String myPreferredEncoding, @NotNull final Charset myDefaultCharset) {
        if (myProject == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "project", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "<init>"));
        }
        if (file == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "projectDir", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "<init>"));
        }
        if (myParameters == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "parameters", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "<init>"));
        }
        if (myDefaultCharset == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "defaultCharset", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "<init>"));
        }
        this.myProject = myProject;
        this.myProjectDir = new File(FileUtil.toCanonicalPath(file.getPath()));
        this.myParameters = myParameters;
        this.myPreferredEncoding = myPreferredEncoding;
        this.myDefaultCharset = myDefaultCharset;
    }
    
    @NotNull
    public CMakeModel generate(@Nullable final CMakeModel cMakeModel, @NotNull final ProgressIndicator progressIndicator) {
        try {
            if (progressIndicator == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "indicator", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "generate"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        try {
            final CMakeModel a = this.a(cMakeModel, progressIndicator);
            final long currentTimeMillis2 = System.currentTimeMillis();
            CMakeModel cMakeModel2;
            try {
                CPPLog.LOG.info("CMake generation took " + StringUtil.formatDuration(currentTimeMillis2 - currentTimeMillis));
                cMakeModel2 = a;
                if (cMakeModel2 == null) {
                    throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "generate"));
                }
            }
            catch (ProcessCanceledException ex2) {
                throw b((Exception)ex2);
            ...
            CPPLog.LOG.info("CMake generation took " + StringUtil.formatDuration(System.currentTimeMillis() - currentTimeMillis));
        }
    }
    
    private CMakeModel a(@Nullable final CMakeModel p0, @NotNull final ProgressIndicator p1) {
        // 
        ...
        //    21: dup            
        //    22: ldc             1
        //    24: ldc             "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator"
        //    26: aastore        
        //    27: dup            
        //    28: ldc             2
        //    30: ldc             "doGenerate"
        ...
        //    39: athrow         
        //    40: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //    43: athrow         
        //    44: invokestatic    com/intellij/openapi/progress/ProgressManager.checkCanceled:()V
        //    47: new             Lgnu/trove/THashSet;
        //    50: dup            
        //    51: getstatic       com/intellij/openapi/util/io/FileUtil.FILE_HASHING_STRATEGY:Lgnu/trove/TObjectHashingStrategy;
        //    54: invokespecial   gnu/trove/THashSet.<init>:(Lgnu/trove/TObjectHashingStrategy;)V
        //    57: astore_3       
        //    58: aload_3        
        //    59: aload_0        
        //    60: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myProjectDir:Ljava/io/File;
        //    63: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.c:(Ljava/io/File;)Ljava/io/File;
        //    66: invokevirtual   gnu/trove/THashSet.add:(Ljava/lang/Object;)Z
        //    69: pop            
        //    70: new             Lgnu/trove/THashSet;
        //    73: dup            
        //    74: getstatic       com/intellij/openapi/util/io/FileUtil.FILE_HASHING_STRATEGY:Lgnu/trove/TObjectHashingStrategy;
        //    77: invokespecial   gnu/trove/THashSet.<init>:(Lgnu/trove/TObjectHashingStrategy;)V
        //    80: astore          4
        //    82: new             Lgnu/trove/THashMap;
        //    85: dup            
        //    86: invokespecial   gnu/trove/THashMap.<init>:()V
        //    89: astore          5
        //    91: new             Ljava/util/concurrent/ExecutorCompletionService;
        //    94: dup            
        //    95: ldc             "CMakeGenerator pool"
        //    97: invokestatic    java/lang/Runtime.getRuntime:()Ljava/lang/Runtime;
        //   100: invokevirtual   java/lang/Runtime.availableProcessors:()I
        //   103: invokestatic    com/intellij/util/concurrency/AppExecutorUtil.createBoundedApplicationPoolExecutor:(Ljava/lang/String;I)Ljava/util/concurrent/ExecutorService;
        //   106: invokespecial   java/util/concurrent/ExecutorCompletionService.<init>:(Ljava/util/concurrent/Executor;)V
        //   109: astore          6
        //   111: aload_0        
        //   112: invokedynamic   value:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator;)Lcom/intellij/openapi/util/Condition;
        //   117: astore          7
        //   119: new             Ljava/io/File;
        //   122: dup            
        //   123: aload_0        
        //   124: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myProjectDir:Ljava/io/File;
        //   127: ldc             "CMakeCache.txt"
        //   129: invokespecial   java/io/File.<init>:(Ljava/io/File;Ljava/lang/String;)V
        //   132: invokevirtual   java/io/File.exists:()Z
        //   135: istore          8
        //   137: aload_0        
        //   138: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myParameters:Ljava/util/List;
        //   141: aload           7
        //   143: invokestatic    com/intellij/util/containers/ContainerUtil.find:(Ljava/lang/Iterable;Lcom/intellij/openapi/util/Condition;)Ljava/lang/Object;
        //   146: ifnull          157
        //   149: iconst_1       
        //   150: goto            158
        //   153: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   156: athrow         
        //   157: iconst_0       
        //   158: istore          9
        //   160: new             Lgnu/trove/THashMap;
        //   163: dup            
        //   164: getstatic       com/intellij/openapi/util/io/FileUtil.FILE_HASHING_STRATEGY:Lgnu/trove/TObjectHashingStrategy;
        //   167: invokespecial   gnu/trove/THashMap.<init>:(Lgnu/trove/TObjectHashingStrategy;)V
        //   170: astore          10
        //   172: new             Ljava/util/ArrayList;
        //   175: dup            
        //   176: aload_0        
        //   177: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myParameters:Ljava/util/List;
        //   180: invokeinterface java/util/List.size:()I
        //   185: invokespecial   java/util/ArrayList.<init>:(I)V
        //   188: astore          11
        //   190: iconst_0       
        //   191: istore          12
        //   193: iload           12
        //   195: aload_0        
        //   196: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myParameters:Ljava/util/List;
        //   199: invokeinterface java/util/List.size:()I
        //   204: if_icmpge       629
        //   207: aload_0        
        //   208: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myParameters:Ljava/util/List;
        //   211: iload           12
        //   213: invokeinterface java/util/List.get:(I)Ljava/lang/Object;
        //   218: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters;
        //   221: astore          13
        //   223: iload           12
        //   225: aload_0        
        //   226: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myParameters:Ljava/util/List;
        ...
        //   239: iconst_1       
        //   240: goto            248
        //   243: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   246: athrow         
        //   247: iconst_0       
        //   248: istore          14
        //   250: iload           9
        ...
        //   257: ifeq            443
        //   260: goto            267
        //   263: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   266: athrow         
        //   267: aload           7
        //   269: aload           13
        //   271: invokeinterface com/intellij/openapi/util/Condition.value:(Ljava/lang/Object;)Z
        //   276: ifne            443
        //   279: goto            286
        //   282: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   285: athrow         
        //   286: iload           9
        //   288: ifeq            392
        //   291: goto            298
        //   294: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   297: athrow         
        //   298: iload           8
        //   300: ifeq            319
        //   303: goto            310
        //   306: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   309: athrow         
        //   310: ldc             "CMakeCache.txt is found in the project dir, only in-source generation will be performed."
        //   312: goto            321
        //   315: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   318: athrow         
        //   319: ldc             "Only in-source generation will be performed."
        //   321: astore          15
        //   323: aload           13
        //   325: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.listener:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeListener;
        //   328: new             Ljava/lang/StringBuilder;
        //   331: dup            
        //   332: invokespecial   java/lang/StringBuilder.<init>:()V
        //   335: ldc             "Cannot generate '"
        //   337: invokevirtual   java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
        //   340: aload           13
        //   342: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.configName:Ljava/lang/String;
        ...
        //   353: aload           13
        //   355: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.generationDir:Ljava/io/File;
        ...
        //   374: aload_0        
        //   375: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myProjectDir:Ljava/io/File;
        //   378: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.c:(Ljava/io/File;)Ljava/io/File;
        //   381: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeMessage.fatalError:(Ljava/lang/String;Ljava/io/File;)Lcom/jetbrains/cidr/cpp/cmake/model/CMakeMessage;
        //   384: invokeinterface com/jetbrains/cidr/cpp/cmake/model/CMakeListener.message:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeMessage;)V
        //   389: goto            623
        //   392: iconst_1       
        //   393: istore          9
        //   395: new             Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters;
        //   398: dup            
        //   399: aload           13
        //   401: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.configId:I
        //   404: aload           13
        //   406: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.configName:Ljava/lang/String;
        //   409: aload_0        
        //   410: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myProjectDir:Ljava/io/File;
        //   413: aload           13
        //   415: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.additionalOptions:Ljava/util/List;
        //   418: aload           13
        //   420: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.passSystemEnvironment:Z
        //   423: aload           13
        //   425: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.additionalEnvironment:Ljava/util/Map;
        //   428: aload           13
        //   430: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.listener:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeListener;
        //   433: aload           13
        //   435: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.environment:Lcom/jetbrains/cidr/cpp/cmake/CMakeEnvironment;
        //   438: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.<init>:(ILjava/lang/String;Ljava/io/File;Ljava/util/List;ZLjava/util/Map;Lcom/jetbrains/cidr/cpp/cmake/model/CMakeListener;Lcom/jetbrains/cidr/cpp/cmake/CMakeEnvironment;)V
        //   441: astore          13
        //   443: aload           10
        //   445: aload           13
        //   447: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.generationDir:Ljava/io/File;
        //   450: invokeinterface java/util/Map.get:(Ljava/lang/Object;)Ljava/lang/Object;
        ...
        //   465: aload           10
        //   467: aload           13
        //   469: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.generationDir:Ljava/io/File;
        //   472: aload           13
        //   474: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.configName:Ljava/lang/String;
        //   477: invokeinterface java/util/Map.put:(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
        //   482: pop            
        //   483: goto            490
        //   486: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   489: athrow         
        //   490: aload_0        
        //   491: aload           13
        //   493: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.environment:Lcom/jetbrains/cidr/cpp/cmake/CMakeEnvironment;
        //   496: aload           13
        //   498: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.generationDir:Ljava/io/File;
        //   501: aload           15
        //   503: invokevirtual   com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.prepareGenerationDirectory:(Lcom/jetbrains/cidr/cpp/cmake/CMakeEnvironment;Ljava/io/File;Ljava/lang/String;)V
        //   506: goto            536
        //   509: astore          16
        //   511: aload           13
        //   513: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.listener:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeListener;
        //   516: aload           16
        //   518: aload_0        
        //   519: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.myProjectDir:Ljava/io/File;
        //   522: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.c:(Ljava/io/File;)Ljava/io/File;
        //   525: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeMessage.fromException:(Lcom/jetbrains/cidr/cpp/cmake/CMakeException;Ljava/io/File;)Lcom/jetbrains/cidr/cpp/cmake/model/CMakeMessage;
        //   528: invokeinterface com/jetbrains/cidr/cpp/cmake/model/CMakeListener.message:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeMessage;)V
        //   533: goto            623
        //   536: aload           13
        //   538: astore          16
        //   540: aload_0        
        ...
        //   547: aload           5
        //   549: aload_2        
        //   550: invokedynamic   call:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator;Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters;Lcom/jetbrains/cidr/cpp/cmake/model/CMakeModel;Lgnu/trove/THashSet;Lgnu/trove/THashSet;Lgnu/trove/THashMap;Lcom/intellij/openapi/progress/ProgressIndicator;)Ljava/util/concurrent/Callable;
        //   555: astore          17
        //   557: iload           14
        //   559: ifeq            608
        //   562: new             Lcom/intellij/util/concurrency/FutureResult;
        //   565: dup            
        //   566: invokespecial   com/intellij/util/concurrency/FutureResult.<init>:()V
        //   569: astore          18
        //   571: aload           18
        //   573: aload           17
        //   575: invokeinterface java/util/concurrent/Callable.call:()Ljava/lang/Object;
        //   580: invokevirtual   com/intellij/util/concurrency/FutureResult.set:(Ljava/lang/Object;)V
        //   583: goto            595
        //   586: astore          19
        //   588: aload           18
        //   590: aload           19
        //   592: invokevirtual   com/intellij/util/concurrency/FutureResult.setException:(Ljava/lang/Throwable;)V
        //   595: aload           11
        //   597: aload           18
        ...
        //   610: aload           6
        //   612: aload           17
        //   614: invokevirtual   java/util/concurrent/ExecutorCompletionService.submit:(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
        ...
        //   632: dup            
        //   633: invokespecial   java/util/ArrayList.<init>:()V
        //   636: astore          12
        //   638: aconst_null    
        //   639: astore          13
        //   641: invokestatic    com/intellij/openapi/progress/ProgressManager.checkCanceled:()V
        //   644: aconst_null    
        //   645: astore          14
        //   647: aload           11
        //   649: invokeinterface java/util/List.iterator:()Ljava/util/Iterator;
        //   654: astore          15
        //   656: aload           15
        //   658: invokeinterface java/util/Iterator.hasNext:()Z
        //   663: ifeq            789
        //   666: aload           15
        //   668: invokeinterface java/util/Iterator.next:()Ljava/lang/Object;
        //   673: checkcast       Ljava/util/concurrent/Future;
        //   676: astore          16
        //   678: aconst_null    
        //   679: astore          17
        //   681: aload           16
        //   683: invokeinterface java/util/concurrent/Future.get:()Ljava/lang/Object;
        //   688: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult;
        //   691: astore          17
        //   693: goto            746
        //   696: astore          18
        //   698: new             Lcom/intellij/openapi/progress/ProcessCanceledException;
        //   701: dup            
        //   702: aload           18
        //   704: invokespecial   com/intellij/openapi/progress/ProcessCanceledException.<init>:(Ljava/lang/Throwable;)V
        //   707: astore          14
        //   709: goto            746
        //   712: astore          18
        //   714: aload           18
        //   716: invokevirtual   java/util/concurrent/ExecutionException.getCause:()Ljava/lang/Throwable;
        //   719: instanceof      Lcom/intellij/openapi/progress/ProcessCanceledException;
        //   722: ifeq            738
        //   725: aload           18
        //   727: invokevirtual   java/util/concurrent/ExecutionException.getCause:()Ljava/lang/Throwable;
        //   730: checkcast       Lcom/intellij/openapi/progress/ProcessCanceledException;
        //   733: astore          14
        //   735: goto            746
        //   738: getstatic       com/jetbrains/cidr/cpp/CPPLog.LOG:Lcom/intellij/openapi/diagnostic/Logger;
        //   741: aload           18
        //   743: invokevirtual   com/intellij/openapi/diagnostic/Logger.error:(Ljava/lang/Throwable;)V
        //   746: aload           17
        //   748: ifnonnull       758
        //   751: goto            656
        //   754: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   757: athrow         
        //   758: aload           12
        //   760: aload           17
        //   762: invokeinterface java/util/List.add:(Ljava/lang/Object;)Z
        //   767: pop            
        //   768: aload           17
        //   770: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult.loadedCacheFile:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeCacheFile;
        //   773: ifnull          786
        //   776: aload           17
        //   778: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult.loadedCacheFile:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeCacheFile;
        //   781: invokevirtual   com/jetbrains/cidr/cpp/cmake/model/CMakeCacheFile.getProjectName:()Ljava/lang/String;
        //   784: astore          13
        //   786: goto            656
        //   789: aload           14
        //   791: ifnull          801
        //   794: aload           14
        //   796: athrow         
        //   797: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   800: athrow         
        //   801: invokestatic    com/intellij/openapi/progress/ProgressManager.checkCanceled:()V
        //   804: aload           13
        //   806: ldc             "Project"
        //   808: invokestatic    com/intellij/openapi/util/text/StringUtil.notNullize:(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
        //   811: astore          13
        //   813: aload_0        
        //   814: aload           13
        //   816: aload           12
        //   818: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.a:(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
        //   821: astore          15
        //   823: aload           4
        //   825: aload_3        
        //   826: invokevirtual   gnu/trove/THashSet.removeAll:(Ljava/util/Collection;)Z
        //   829: pop            
        //   830: aload           15
        //   832: invokeinterface java/util/List.iterator:()Ljava/util/Iterator;
        //   837: astore          16
        //   839: aload           16
        //   841: invokeinterface java/util/Iterator.hasNext:()Z
        //   846: ifeq            912
        //   849: aload           16
        //   851: invokeinterface java/util/Iterator.next:()Ljava/lang/Object;
        //   856: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeTarget;
        //   859: astore          17
        //   861: aload           17
        //   863: invokevirtual   com/jetbrains/cidr/cpp/cmake/model/CMakeTarget.getBuildConfigurations:()Ljava/util/List;
        //   866: invokeinterface java/util/List.iterator:()Ljava/util/Iterator;
        //   871: astore          18
        //   873: aload           18
        //   875: invokeinterface java/util/Iterator.hasNext:()Z
        //   880: ifeq            909
        //   883: aload           18
        //   885: invokeinterface java/util/Iterator.next:()Ljava/lang/Object;
        //   890: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration;
        //   893: astore          19
        //   895: aload           4
        //   897: aload           19
        //   899: invokevirtual   com/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration.getSources:()Ljava/util/Collection;
        //   902: invokevirtual   gnu/trove/THashSet.removeAll:(Ljava/util/Collection;)Z
        //   905: pop            
        //   906: goto            873
        //   909: goto            839
        //   912: aload           4
        //   914: invokevirtual   gnu/trove/THashSet.compact:()V
        //   917: aload_3        
        //   918: invokevirtual   gnu/trove/THashSet.compact:()V
        //   921: aload           5
        //   923: invokevirtual   gnu/trove/THashMap.compact:()V
        //   926: aload           12
        //   928: invokedynamic   fun:()Lcom/intellij/util/Function;
        //   933: invokestatic    com/intellij/util/containers/ContainerUtil.map:(Ljava/util/Collection;Lcom/intellij/util/Function;)Ljava/util/List;
        //   936: astore          16
        //   938: new             Lcom/jetbrains/cidr/cpp/cmake/model/CMakeModel;
        //   941: dup            
        //   942: aload           13
        //   944: aload_3        
        //   945: aload           4
        ...
        //   949: aload           5
        //   951: aload           16
        //   953: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeModel.<init>:(Ljava/lang/String;Ljava/util/Set;Ljava/util/Set;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)V
        //   956: areturn        
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type                                         
        //  -----  -----  -----  -----  ---------------------------------------------
        //  460    483    486    490    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  298    315    315    319    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  286    303    306    310    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  267    291    294    298    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  255    279    282    286    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  250    260    263    267    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  223    243    243    247    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  137    153    153    157    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  0      40     40     44     Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  490    506    509    536    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  571    583    586    595    Ljava/lang/Throwable;
        //  681    693    696    712    Ljava/lang/InterruptedException;
        //  681    693    712    746    Ljava/util/concurrent/ExecutionException;
        //  746    754    754    758    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  789    797    797    801    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        // 
    ...
    @NotNull
    private List<CMakeTarget> a(@NotNull final String p0, @NotNull final List<ConfigGenerationResult> p1) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //    59: dup            
        //    60: ldc             0
        //    62: ldc             "generationResults"
        //    64: aastore        
        //    65: dup            
        //    66: ldc             1
        //    68: ldc             "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator"
        //    70: aastore        
        //    71: dup            
        //    72: ldc             2
        //    74: ldc             "convertToTargets"
        //    76: aastore        
        //    77: invokestatic    java/lang/String.format:(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
        //    80: invokespecial   java/lang/IllegalArgumentException.<init>:(Ljava/lang/String;)V
        //    83: athrow         
        //    84: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //    87: athrow         
        //    88: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.a:()Ljava/util/Map;
        //    91: astore_3       
        //    92: aload_2        
        ...
        //   117: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult;
        //   120: astore          5
        //   122: aload           5
        //   124: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult.targetInfos:Ljava/util/List;
        ...
        //   151: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo;
        //   154: astore          7
        //   156: aload_3        
        //   157: aload           7
        //   159: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.targetName:Ljava/lang/String;
        //   162: aload           7
        //   164: aload_2        
        //   165: invokedynamic   apply:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo;Ljava/util/List;)Ljava/util/function/Function;
        //   170: invokeinterface java/util/Map.computeIfAbsent:(Ljava/lang/Object;Ljava/util/function/Function;)Ljava/lang/Object;
        //   175: checkcast       Lcom/intellij/openapi/util/Pair;
        //   178: astore          8
        //   180: aload           5
        //   182: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult.codeBlocksProject:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeCodeBlocks;
        //   185: astore          9
        //   187: aload           9
        //   189: ifnonnull       200
        //   192: aconst_null    
        //   193: goto            218
        //   196: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   199: athrow         
        //   200: aload           9
        //   202: invokevirtual   com/jetbrains/cidr/cpp/cmake/model/CMakeCodeBlocks.getTargetTypes:()Ljava/util/Map;
        //   205: aload           7
        //   207: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.targetName:Ljava/lang/String;
        //   210: invokeinterface java/util/Map.get:(Ljava/lang/Object;)Ljava/lang/Object;
        //   215: checkcast       Ljava/lang/String;
        //   218: astore          10
        //   220: aload           8
        //   222: getfield        com/intellij/openapi/util/Pair.second:Ljava/lang/Object;
        //   225: checkcast       Ljava/util/List;
        //   228: new             Lcom/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration;
        //   231: dup            
        //   232: aload           5
        //   234: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult.parameters:Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters;
        //   237: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$Parameters.configId:I
        //   240: aload           5
        //   242: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult.actualConfigName:Ljava/lang/String;
        //   245: aload           7
        //   247: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.generatedDir:Ljava/io/File;
        //   250: aload           7
        //   252: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.targetDir:Ljava/io/File;
        //   255: aload           7
        //   257: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.perLanguageSettings:Ljava/util/Map;
        //   260: aload           7
        //   262: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.linkerFlags:Ljava/util/List;
        //   265: invokestatic    com/intellij/util/containers/ContainerUtil.notNullize:(Ljava/util/List;)Ljava/util/List;
        //   268: aload           7
        //   270: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.sources:Ljava/util/Map;
        //   273: aload           7
        //   275: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.productFile:Ljava/io/File;
        //   278: aload           7
        //   280: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.buildWorkingDir:Ljava/io/File;
        //   283: aload           10
        //   285: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration$TargetType.fromString:(Ljava/lang/String;)Lcom/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration$TargetType;
        //   288: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration.<init>:(ILjava/lang/String;Ljava/io/File;Ljava/io/File;Ljava/util/Map;Ljava/util/List;Ljava/util/Map;Ljava/io/File;Ljava/io/File;Lcom/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration$TargetType;)V
        //   291: invokeinterface java/util/List.add:(Ljava/lang/Object;)Z
        //   296: pop            
        //   297: goto            134
        //   300: goto            100
        ...
        //   312: aload           4
        //   314: aload_3        
        //   315: invokeinterface java/util/Map.values:()Ljava/util/Collection;
        //   320: invokeinterface java/util/List.addAll:(Ljava/util/Collection;)Z
        //   325: pop            
        //   326: aload           4
        //   328: new             Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$1;
        //   331: dup            
        //   332: aload_0        
        //   333: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$1.<init>:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator;)V
        //   336: invokestatic    java/util/Collections.sort:(Ljava/util/List;Ljava/util/Comparator;)V
        //   339: new             Ljava/util/ArrayList;
        //   342: dup            
        //   343: aload           4
        //   345: invokeinterface java/util/List.size:()I
        //   350: invokespecial   java/util/ArrayList.<init>:(I)V
        //   353: astore          5
        //   355: aload           4
        ...
        //   381: checkcast       Lcom/intellij/openapi/util/Pair;
        //   384: astore          7
        //   386: new             Lcom/jetbrains/cidr/cpp/cmake/model/CMakeTarget;
        //   389: dup            
        //   390: aload_1        
        //   391: aload           7
        //   393: getfield        com/intellij/openapi/util/Pair.first:Ljava/lang/Object;
        //   396: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo;
        //   399: getfield        com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$PerConfigurationTargetInfo.targetName:Ljava/lang/String;
        //   402: aload           7
        //   404: getfield        com/intellij/openapi/util/Pair.second:Ljava/lang/Object;
        //   407: checkcast       Ljava/util/List;
        //   410: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeTarget.<init>:(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
        //   413: astore          8
        //   415: aload           7
        //   417: getfield        com/intellij/openapi/util/Pair.second:Ljava/lang/Object;
        //   420: checkcast       Ljava/util/List;
        //   423: invokeinterface java/util/List.iterator:()Ljava/util/Iterator;
        //   428: astore          9
        //   430: aload           9
        ...
        //   447: checkcast       Lcom/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration;
        //   450: astore          10
        //   452: aload           10
        //   454: aload           8
        //   456: invokevirtual   com/jetbrains/cidr/cpp/cmake/model/CMakeConfiguration.initTarget:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeTarget;)V
        //   459: goto            430
        //   462: aload           5
        //   464: aload           8
        ...
        //   492: dup            
        //   493: ldc             0
        //   495: ldc             "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator"
        //   497: aastore        
        //   498: dup            
        //   499: ldc             1
        //   501: ldc             "convertToTargets"
        //   503: aastore        
        ...
        //   510: athrow         
        //   511: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   514: athrow         
        //   515: areturn        
        //    Signature:
        //  (Ljava/lang/String;Ljava/util/List<Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator$ConfigGenerationResult;>;)Ljava/util/List<Lcom/jetbrains/cidr/cpp/cmake/model/CMakeTarget;>;
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type                                                    
        //  -----  -----  -----  -----  --------------------------------------------------------
        ...
        //  187    196    196    200    Lcom/intellij/openapi/progress/ProcessCanceledException;
        //  475    511    511    515    Lcom/intellij/openapi/progress/ProcessCanceledException;
        // 
        // The error that occurred was:
        // 
    ...
    public void prepareGenerationDirectory(@NotNull final CMakeEnvironment p0, @NotNull final File p1, @Nullable final String p2) throws CMakeException {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //    27: dup            
        //    28: ldc             2
        //    30: ldc             "prepareGenerationDirectory"
        //    32: aastore        
        //    33: invokestatic    java/lang/String.format:(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
        //    36: invokespecial   java/lang/IllegalArgumentException.<init>:(Ljava/lang/String;)V
        //    39: athrow         
        ...
        //    71: dup            
        //    72: ldc             2
        //    74: ldc             "prepareGenerationDirectory"
        //    76: aastore        
        //    77: invokestatic    java/lang/String.format:(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
        //    80: invokespecial   java/lang/IllegalArgumentException.<init>:(Ljava/lang/String;)V
        //    83: athrow         
        ...
        //    88: aload_3        
        //    89: ifnull          137
        //    92: new             Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //    95: dup            
        //    96: new             Ljava/lang/StringBuilder;
        //    99: dup            
        //   100: invokespecial   java/lang/StringBuilder.<init>:()V
        //   103: ldc             "Cannot generate into "
        ...
        //   112: ldc             "\nThis directory is already used for '"
        //   114: invokevirtual   java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
        //   117: aload_3        
        //   118: invokevirtual   java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
        //   121: ldc             "' configuration"
        //   123: invokevirtual   java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
        //   126: invokevirtual   java/lang/StringBuilder.toString:()Ljava/lang/String;
        //   129: invokespecial   com/jetbrains/cidr/cpp/cmake/CMakeException.<init>:(Ljava/lang/String;)V
        //   132: athrow         
        //   133: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   136: athrow         
        //   137: aload_2        
        //   138: invokevirtual   java/io/File.exists:()Z
        //   141: ifeq            194
        //   144: aload_2        
        //   145: invokevirtual   java/io/File.isDirectory:()Z
        //   148: ifne            194
        //   151: goto            158
        //   154: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   157: athrow         
        //   158: new             Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //   161: dup            
        //   162: new             Ljava/lang/StringBuilder;
        //   165: dup            
        //   166: invokespecial   java/lang/StringBuilder.<init>:()V
        //   169: ldc             "Cannot generate into "
        ...
        //   186: invokespecial   com/jetbrains/cidr/cpp/cmake/CMakeException.<init>:(Ljava/lang/String;)V
        //   189: athrow         
        //   190: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   193: athrow         
        //   194: aload_2        
        //   195: invokevirtual   java/io/File.exists:()Z
        //   198: ifne            246
        //   201: aload_2        
        //   202: invokevirtual   java/io/File.mkdirs:()Z
        //   205: ifne            246
        //   208: goto            215
        //   211: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   214: athrow         
        //   215: new             Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //   218: dup            
        //   219: new             Ljava/lang/StringBuilder;
        //   222: dup            
        //   223: invokespecial   java/lang/StringBuilder.<init>:()V
        //   226: ldc             "Cannot create directory "
        ...
        //   238: invokespecial   com/jetbrains/cidr/cpp/cmake/CMakeException.<init>:(Ljava/lang/String;)V
        //   241: athrow         
        //   242: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   245: athrow         
        //   246: aload_1        
        //   247: invokevirtual   com/jetbrains/cidr/cpp/cmake/CMakeEnvironment.getUniqueID:()Ljava/lang/String;
        //   250: astore          4
        //   252: aload_2        
        //   253: ldc             "environment.txt"
        //   255: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.getCMakeFilesProductFile:(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
        //   258: astore          5
        //   260: aload           5
        //   262: aload           4
        //   264: invokedynamic   compute:(Ljava/io/File;Ljava/lang/String;)Lcom/intellij/openapi/util/ThrowableComputable;
        //   269: astore          6
        //   271: aload_0        
        //   272: aload_1        
        //   273: invokedynamic   apply:(Lcom/jetbrains/cidr/cpp/cmake/model/CMakeGenerator;Lcom/jetbrains/cidr/cpp/cmake/CMakeEnvironment;)Ljava/util/function/Function;
        //   278: astore          7
        //   280: aload_1        
        //   281: invokedynamic   apply:(Lcom/jetbrains/cidr/cpp/cmake/CMakeEnvironment;)Ljava/util/function/Function;
        //   286: astore          8
        //   288: new             Ljava/io/File;
        //   291: dup            
        //   292: aload_2        
        //   293: ldc             "CMakeCache.txt"
        //   295: invokespecial   java/io/File.<init>:(Ljava/io/File;Ljava/lang/String;)V
        //   298: astore          9
        //   300: aload           6
        //   302: invokeinterface com/intellij/openapi/util/ThrowableComputable.compute:()Ljava/lang/Object;
        ...
        //   317: ifne            411
        //   320: aload           9
        //   322: invokevirtual   java/io/File.exists:()Z
        //   325: ifeq            411
        //   328: goto            335
        //   331: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   334: athrow         
        //   335: new             Lcom/jetbrains/cidr/cpp/cmake/model/CMakeCacheFile;
        //   338: dup            
        //   339: aload           9
        //   341: aload_0        
        //   342: aload           9
        //   344: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/io/File;)Ljava/lang/String;
        //   347: invokespecial   com/jetbrains/cidr/cpp/cmake/model/CMakeCacheFile.<init>:(Ljava/io/File;Ljava/lang/String;)V
        //   350: astore          11
        //   352: aload           7
        //   354: aload           11
        //   356: invokeinterface java/util/function/Function.apply:(Ljava/lang/Object;)Ljava/lang/Object;
        //   361: checkcast       Ljava/lang/Boolean;
        //   364: invokevirtual   java/lang/Boolean.booleanValue:()Z
        //   367: ifne            395
        //   370: aload           8
        //   372: aload           11
        //   374: invokeinterface java/util/function/Function.apply:(Ljava/lang/Object;)Ljava/lang/Object;
        //   379: checkcast       Ljava/lang/Boolean;
        //   382: invokevirtual   java/lang/Boolean.booleanValue:()Z
        //   385: ifeq            403
        //   388: goto            395
        //   391: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   394: athrow         
        //   395: iconst_1       
        //   396: goto            404
        //   399: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   402: athrow         
        //   403: iconst_0       
        //   404: istore          10
        //   406: goto            411
        ...
        //   413: ifeq            427
        //   416: aload_2        
        //   417: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.clearGeneratedCMakeFiles:(Ljava/io/File;)V
        //   420: goto            427
        //   423: invokestatic    com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator.b:(Ljava/lang/Exception;)Ljava/lang/Exception;
        //   426: athrow         
        //   427: aload           5
        //   429: aload           4
        //   431: invokestatic    com/intellij/openapi/util/io/FileUtil.writeToFile:(Ljava/io/File;Ljava/lang/String;)V
        //   434: goto            469
        //   437: astore          11
        //   439: new             Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //   442: dup            
        //   443: new             Ljava/lang/StringBuilder;
        //   446: dup            
        //   447: invokespecial   java/lang/StringBuilder.<init>:()V
        //   450: ldc             "Cannot save file "
        ...
        //   463: aload           11
        //   465: invokespecial   com/jetbrains/cidr/cpp/cmake/CMakeException.<init>:(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   468: athrow         
        //   469: return         
        //    Exceptions:
        ...
        //  Start  End    Start  End    Type                                         
        //  -----  -----  -----  -----  ---------------------------------------------
        //  370    399    399    403    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  352    388    391    395    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  315    328    331    335    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  201    242    242    246    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  194    208    211    215    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  144    190    190    194    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  137    151    154    158    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  88     133    133    137    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  44     84     84     88     Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  0      40     40     44     Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  335    406    409    411    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  411    420    423    427    Lcom/jetbrains/cidr/cpp/cmake/CMakeException;
        //  427    434    437    469    Ljava/io/IOException;
        // 
        // The error that occurred was:
        // 
        // java.lang.IllegalStateException: Could not infer any expression.
    ...
    public static void clearGeneratedCMakeFiles(@NotNull final File file) {
        try {
            if (file == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "generationDir", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "clearGeneratedCMakeFiles"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        }
        FileUtil.delete(new File(file, "CMakeFiles"));
        FileUtil.delete(new File(file, "CMakeCache.txt"));
    }
    
    @NotNull
    public static File getCMakeFilesProductFile(@NotNull final File file, @NotNull final String s) {
        try {
            if (file == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "generationDir", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getCMakeFilesProductFile"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "fileName", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getCMakeFilesProductFile"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw b((Exception)ex2);
        }
        final String sanitizeFileName = FileUtil.sanitizeFileName(StringUtil.toLowerCase(ApplicationNamesInfo.getInstance().getProductName()));
        File file2;
        try {
            file2 = new File(file, "CMakeFiles/" + sanitizeFileName + "-" + s);
            if (file2 == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getCMakeFilesProductFile"));
            }
        }
    ...
    @NotNull
    private static File c(@NotNull final File file) {
        try {
            if (file == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "dir", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getCMakeListsFile"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        File file2;
        try {
            file2 = new File(FileUtil.toCanonicalPath(new File(file, "CMakeLists.txt").getPath()));
            if (file2 == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getCMakeListsFile"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw b((Exception)ex2);
    ...
    @NotNull
    private static File a(@NotNull final CMakeEnvironment cMakeEnvironment, @NotNull final String s) {
        try {
            if (cMakeEnvironment == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "environment", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toLocalFile"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "absolutePath", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toLocalFile"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw b((Exception)ex2);
        ...
        File a;
        try {
            a = a(cMakeEnvironment, null, s);
            if (a == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toLocalFile"));
            }
        }
        catch (ProcessCanceledException ex3) {
            throw b((Exception)ex3);
    ...
    @NotNull
    private static File a(@NotNull final CMakeEnvironment cMakeEnvironment, @Nullable final File file, @NotNull final String s) {
        try {
            if (cMakeEnvironment == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "environment", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toLocalFile"));
            }
        ...
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "absoluteOrRelativePath", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toLocalFile"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw b((Exception)ex2);
        ...
        File file2;
        try {
            file2 = new File(cMakeEnvironment.toLocalPath(file, s));
            if (file2 == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toLocalFile"));
            }
        }
    ...
    @NotNull
    private static String b(@NotNull final CMakeEnvironment cMakeEnvironment, @NotNull final String s) {
        try {
            if (cMakeEnvironment == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "environment", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toEnvPath"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "absoluteLocalPath", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toEnvPath"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw b((Exception)ex2);
        ...
        String envPath;
        try {
            envPath = cMakeEnvironment.toEnvPath(s);
            if (envPath == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "toEnvPath"));
            }
        }
        catch (ProcessCanceledException ex3) {
            throw b((Exception)ex3);
    ...
    private static <T> Map<String, T> a() {
        return new LinkedHashMap<String, T>();
    }
    
    private CMakeFile a(@NotNull final File file) throws CMakeException {
        try {
            if (file == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "file", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "parseCMakeFile"));
            }
        }
        ...
        String loadFile;
        try {
            loadFile = FileUtil.loadFile(file, this.b(file));
        }
        catch (IOException ex2) {
            throw CMakeException.cannotReadFile(file, ex2);
        }
        return this.b((com.intellij.openapi.util.Computable<CMakeFile>)(() -> CMakeElementFactory.createFile(this.myProject, loadFile)));
    }
    
    private List<String> b(@NotNull final CMakeFile cMakeFile, @Nullable final String s) {
        try {
            if (cMakeFile == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "file", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getCMakeVariableValues"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        }
        return this.b((com.intellij.openapi.util.Computable<List<String>>)(() -> {
            try {
                if (cMakeFile == null) {
                    throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "file", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "lambda$getCMakeVariableValues$9"));
                }
            }
            catch (ProcessCanceledException ex) {
                throw b((Exception)ex);
            }
            return cMakeFile.findFirstVariableValues(s);
        }));
    }
    
    private <T> T b(final Computable<T> computable) {
    ...
    @NotNull
    private ProcessOutput a(@NotNull final Parameters parameters) throws CMakeException {
        try {
            if (parameters == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "parameters", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex) {
            throw b(ex);
        }
        final String configName = parameters.configName;
        Label_0074: {
            try {
                if (CMakeGenerator.ourEmulateCMakeExecutionErrorInDebugConfig == null) {
                    break Label_0074;
                }
                final List<String> list = CMakeGenerator.ourEmulateCMakeExecutionErrorInDebugConfig;
                final String s = configName;
                final boolean b = list.contains(s);
                if (b) {
                    break Label_0074;
                }
                break Label_0074;
            ...
            try {
                ...
                final boolean b = list.contains(s);
                if (b) {
                    throw new EmulatedCMakeException("Emulated CMake error in " + configName);
                }
            }
        ...
        ProcessOutput runCMakeGenerator;
        try {
            list2.add(getBuildTypeOption(configName));
            list2.addAll((Collection<?>)parameters.additionalOptions);
            runCMakeGenerator = runCMakeGenerator(new CMakeRunner(parameters.environment), this.myProjectDir, parameters.generationDir, true, list2, parameters.passSystemEnvironment, parameters.additionalEnvironment, new CMakeRunner.Listener() {
                @Override
                public void processStarted(@NotNull final ProcessHandler processHandler) {
                    ...
                    parameters.listener.attachTo(processHandler);
                }
            ...
            if (runCMakeGenerator == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex4) {
            throw b(ex4);
        }
        return runCMakeGenerator;
    }
    
    @NotNull
    public static String getBuildTypeOption(@NotNull final String s) {
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "configName", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getBuildTypeOption"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        Label_0075: {
            ...
            try {
                append = new StringBuilder().append("-DCMAKE_BUILD_TYPE=");
                if (s.equals("Default")) {
                    final String s2 = "";
                    break Label_0075;
                }
            ...
            try {
                ...
                if (string == null) {
                    throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getBuildTypeOption"));
                }
            }
            catch (ProcessCanceledException ex3) {
                throw b((Exception)ex3);
    ...
    @NotNull
    public static ProcessOutput runCMakeGenerator(@NotNull final CMakeRunner cMakeRunner, @NotNull final File file, @NotNull final File file2) throws CMakeException {
        try {
            if (cMakeRunner == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "runner", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex) {
            throw b(ex);
        ...
        try {
            if (file == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "projectDir", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex2) {
            throw b(ex2);
        ...
        try {
            if (file2 == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "outputDir", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex3) {
            throw b(ex3);
        ...
        ProcessOutput runCMakeGenerator;
        try {
            runCMakeGenerator = runCMakeGenerator(cMakeRunner, file, file2, Collections.emptyList());
            if (runCMakeGenerator == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
    ...
    @NotNull
    public static ProcessOutput runCMakeGenerator(@NotNull final CMakeRunner cMakeRunner, @NotNull final File file, @NotNull final File file2, @NotNull final List<String> list) throws CMakeException {
        try {
            if (cMakeRunner == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "runner", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        ...
        try {
            if (list == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "commandLineOptions", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex4) {
            throw b(ex4);
        ...
        ProcessOutput runCMakeGenerator;
        try {
            runCMakeGenerator = runCMakeGenerator(cMakeRunner, file, file2, false, list, true, Collections.emptyMap(), new CMakeRunner.Listener() {});
            if (runCMakeGenerator == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex5) {
            throw b(ex5);
        }
        return runCMakeGenerator;
    }
    ...
    @NotNull
    public static ProcessOutput runCMakeGenerator(@NotNull final CMakeRunner cMakeRunner, @NotNull final File file, @NotNull final File file2, final boolean b, final List<String> list, final boolean b2, @NotNull final Map<String, String> map, @NotNull final CMakeRunner.Listener listener) throws CMakeException {
        try {
            if (cMakeRunner == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "runner", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        ...
        try {
            if (map == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "additionalEnvironment", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex4) {
            throw b(ex4);
        ...
        try {
            if (listener == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "listener", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex5) {
            throw b(ex5);
        ...
        ProcessOutput runCMake;
        try {
            list2.addAll(list);
            list2.add("-G");
            list2.add(a(cMakeRunner.getEnvironment(), b));
            runCMake = cMakeRunner.runCMake(file, file2, (List<String>)list2, b2, map, listener);
            if (runCMake == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "runCMakeGenerator"));
            }
        }
        catch (CMakeException ex6) {
            throw b(ex6);
        }
        return runCMake;
    }
    ...
    @NotNull
    private static String a(@NotNull final CMakeEnvironment cMakeEnvironment, final boolean b) {
        try {
            if (cMakeEnvironment == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "environment", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getGeneratorSpec"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw b((Exception)ex);
        ...
        try {
            generatorSpec = getGeneratorSpec(cMakeEnvironment.getToolSet(), b);
            if (generatorSpec == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getGeneratorSpec"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw b((Exception)ex2);
    ...
    @NotNull
    public static String getGeneratorSpec(@Nullable final CidrToolSet set, final boolean b) {
        String string = null;
        Label_0072: {
            CMakeGeneratorType cMakeGeneratorType = null;
            ...
            Label_0050: {
                Label_0046: {
                    Label_0025: {
                        ...
                        cMakeGeneratorType = CMakeGeneratorType.MINGW;
                        break Label_0050;
                    }
                    if (set.isCygwin()) {
                        cMakeGeneratorType = CMakeGeneratorType.UNIX;
                        break Label_0050;
                    }
                    cMakeGeneratorType = CMakeGeneratorType.NMAKE;
                    break Label_0050;
                }
                cMakeGeneratorType = CMakeGeneratorType.UNIX;
                try {
            ...
            final String s = "";
            try {
                string = sb.append(s).append(cMakeGeneratorType.getValue()).toString();
                if (string == null) {
                    throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "getGeneratorSpec"));
                }
            }
    ...
    @NotNull
    private String b(@NotNull final File file) {
        try {
            if (file == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "file", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "encodingForFile"));
            }
        }
        catch (IOException ex) {
            throw b(ex);
        ...
        Label_0101: {
            ...
            Label_0066: {
                try {
                    ...
                    final CMakeGenerator cMakeGenerator = this;
                    s = cMakeGenerator.myPreferredEncoding;
                    if (s == null) {
                        break Label_0066;
                    }
                    return s;
                ...
                try {
                    ...
                    s = cMakeGenerator.myPreferredEncoding;
                    if (s == null) {
                        throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "encodingForFile"));
                    }
                }
            ...
            return s;
            try {
                final Charset guessEncoding = CharsetToolkit.guessEncoding(file, (int)file.length(), this.myDefaultCharset);
                Charset myDefaultCharset = null;
                Label_0131: {
                    try {
                        if (guessEncoding == null) {
                            myDefaultCharset = this.myDefaultCharset;
                            break Label_0131;
                        }
                    }
                    ...
                    myDefaultCharset = guessEncoding;
                }
                final String name = myDefaultCharset.name();
                if (name == null) {
                    throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "encodingForFile"));
                }
                return name;
                ...
                String name2;
                try {
                    name2 = this.myDefaultCharset.name();
                    if (name2 == null) {
                        throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/cpp/cmake/model/CMakeGenerator", "encodingForFile"));
                    }
                }
    ...
    static {
        ...
        Label_0017: {
            try {
                s = "CMakeFiles/(?:[^/]+/)?CMake(\\w+)Compiler\\.cmake";
        ...
        CMAKE_COMPILER_FILE_PATTERN = Pattern.compile(s, n);
        CMakeGenerator.ourEmulateCMakeExecutionErrorInDebugConfig = null;
        CMakeGenerator.ourEmulateProductNotFoundForTargetAndConfig = null;
    }
    ...
    private class ConfigGenerationResult
    {
        ...
        private void a(@Nullable final CMakeCodeBlocks cMakeCodeBlocks, @NotNull final Set<File> set, @NotNull final Set<File> set2) {
            ...
            if (cMakeCodeBlocks != null) {
                for (final Map.Entry<String, String> entry : cMakeCodeBlocks.getFilePathsWithFolders().entrySet()) {
                    final File access$600 = a(this.parameters.environment, FileUtil.toCanonicalPath((String)entry.getKey(), true));
                    try {
        ...
        private CMakeCodeBlocks a(@NotNull final CMakeCacheFile cMakeCacheFile) {
            ...
            try {
                ...
                this.parameters.listener.message(new CMakeMessage(CMakeMessage.MessageLevel.ERROR, c(CMakeGenerator.this.myProjectDir), null, string));
            }
            catch (IOException ex3) {
                final String string2 = "Cannot read project file " + file;
                CPPLog.LOG.warn(string2, (Throwable)ex3);
                this.parameters.listener.message(new CMakeMessage(CMakeMessage.MessageLevel.ERROR, c(CMakeGenerator.this.myProjectDir), null, string2));
            }
            return null;
        }
        ...
        private void a(final Map<String, OCLanguageKind> map) {
            ...
            final Iterator iterator = CMakeGenerator.this.b(a, "CMAKE_MAKEFILE_DEPENDS").iterator();
            while (iterator.hasNext()) {
                final File access$600 = a(this.parameters.environment, iterator.next());
                final Matcher matcher = CMakeGenerator.CMAKE_COMPILER_FILE_PATTERN.matcher(FileUtil.toSystemIndependentName(access$600.getPath()));
                try {
                    if (!matcher.matches()) {
                        continue;
                    }
                ...
                try {
                    final Iterator iterator2 = CMakeGenerator.this.b(CMakeGenerator.this.a(new File(this.parameters.generationDir, access$600.getPath())), "CMAKE_" + group + "_SOURCE_FILE_EXTENSIONS").iterator();
                    ...
                    this.parameters.listener.message(new CMakeMessage(CMakeMessage.MessageLevel.ERROR, c(CMakeGenerator.this.myProjectDir), null, ex4.getMessage()));
                }
            }
        }
        ...
        private File c(@Nullable final String s) {
            ...
            try {
                if (nullize != null) {
                    return a(this.parameters.environment, nullize);
                }
            }
            catch (IllegalArgumentException ex) {
                throw b(ex);
        ...
        private List<PerConfigurationTargetInfo> b(@NotNull final CMakeCacheFile cMakeCacheFile) {
            ...
            this.a(this.parameters.generationDir, this.parameters.listener, (Processor<File>)(file -> {
                ...
                File file3 = c(CMakeGenerator.this.myProjectDir);
                try {
                    for (final String s : FileUtil.loadLines(new File(parentFile, "cmake_install.cmake"))) {
                        if (s.startsWith("# Install script for directory:")) {
                            file3 = c(a(this.parameters.environment, StringUtil.trimStart(s, "# Install script for directory:").trim()));
                        }
                    }
                }
                catch (IOException ex4) {
        ...
        private boolean a(@NotNull final File file, @NotNull final CMakeListener cMakeListener, @NotNull final Processor<File> processor) {
            ...
            try {
                final Iterator iterator = FileUtil.loadLines(file2, CMakeGenerator.this.b(file2)).iterator();
                while (iterator.hasNext()) {
                    final File access$600 = a(this.parameters.environment, iterator.next());
                    try {
    ...
    private static class EmulatedCMakeException extends CMakeException
    {
        public EmulatedCMakeException(final String s) {
            super(s);
        }
    }
    ...
    private class PerTargetInfoComparator implements Comparator<PerConfigurationTargetInfo>
    {
        ...
        private PerTargetInfoComparator() {
            this.mainCMakeLists = c(CMakeGenerator.this.myProjectDir);
        }
