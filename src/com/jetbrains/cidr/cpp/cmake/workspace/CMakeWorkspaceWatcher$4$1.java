...
class CMakeWorkspaceWatcher$4$1 extends Update {
    public void run() {
        // 
    ...
    private void b() {
        ((CMakeWorkspaceListener)CMakeWorkspaceWatcher.access$200(DocumentListener.this.this$0).getMessageBus().syncPublisher((Topic)CMakeWorkspaceListener.TOPIC)).reloadingRescheduled();
        CMakeWorkspaceWatcher.access$000(DocumentListener.this.this$0).restartTimer();
        CMakeWorkspaceWatcher.access$000(DocumentListener.this.this$0).queue((Update)this);
    }
    ...
    private boolean a(@NotNull final Collection<File> collection, @NotNull final NotNullFunction<File, FileStampFunctionAdapter> notNullFunction) {
        ...
        try {
            if (!ContainerUtil.exists((Iterable)collection, file -> {
                ...
                final CMakeFile cMakeFile = ((FileStampFunctionAdapter)notNullFunction.fun((Object)file)).getCMakeFile(CMakeWorkspaceWatcher.access$200(DocumentListener.this.this$0));
                Label_0086: {
                    try {
                        if (cMakeFile == null) {
                            return false;
