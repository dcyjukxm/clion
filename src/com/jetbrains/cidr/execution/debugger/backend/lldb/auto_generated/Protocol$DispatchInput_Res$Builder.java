...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements DispatchInput_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$49300();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$49400().ensureFieldAccessorsInitialized((Class)DispatchInput_Res.class, (Class)Builder.class);
    }
    ...
    private void a() {
        try {
            if (DispatchInput_Res.access$49800()) {
                this.c();
            }
        }
    ...
    public DispatchInput_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    DispatchInput_Res.access$50002(dispatchInput_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            DispatchInput_Res.access$50002(dispatchInput_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        DispatchInput_Res.access$50102(dispatchInput_Res, n);
        this.onBuilt();
