...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements GetValueAddress_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$59800();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$59900().ensureFieldAccessorsInitialized((Class)GetValueAddress_Res.class, (Class)Builder.class);
    }
    ...
    private void b() {
        try {
            if (GetValueAddress_Res.access$60300()) {
                this.a();
            }
        }
    ...
    public GetValueAddress_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    GetValueAddress_Res.access$60502(getValueAddress_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            GetValueAddress_Res.access$60502(getValueAddress_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        if ((bitField0_ & 0x2) == 0x2) {
            n |= 0x2;
        }
        GetValueAddress_Res.access$60602(getValueAddress_Res, this.address_);
        GetValueAddress_Res.access$60702(getValueAddress_Res, n);
        this.onBuilt();
