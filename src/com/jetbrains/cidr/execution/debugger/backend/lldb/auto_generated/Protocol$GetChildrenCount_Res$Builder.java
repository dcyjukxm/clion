...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements GetChildrenCount_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$43900();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$44000().ensureFieldAccessorsInitialized((Class)GetChildrenCount_Res.class, (Class)Builder.class);
    }
    ...
    private void a() {
        try {
            if (GetChildrenCount_Res.access$44400()) {
                this.c();
            }
        }
    ...
    public GetChildrenCount_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    GetChildrenCount_Res.access$44602(getChildrenCount_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            GetChildrenCount_Res.access$44602(getChildrenCount_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        if ((bitField0_ & 0x2) == 0x2) {
            n |= 0x2;
        }
        GetChildrenCount_Res.access$44702(getChildrenCount_Res, this.count_);
        GetChildrenCount_Res.access$44802(getChildrenCount_Res, n);
        this.onBuilt();
