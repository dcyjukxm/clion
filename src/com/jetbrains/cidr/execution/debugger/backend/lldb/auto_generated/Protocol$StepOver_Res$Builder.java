...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements StepOver_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$26500();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$26600().ensureFieldAccessorsInitialized((Class)StepOver_Res.class, (Class)Builder.class);
    }
    ...
    public StepOver_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    StepOver_Res.access$27202(stepOver_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            StepOver_Res.access$27202(stepOver_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        StepOver_Res.access$27302(stepOver_Res, n);
        this.onBuilt();
        return stepOver_Res;
    }
