...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements RemoveWatchpoint_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$33600();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$33700().ensureFieldAccessorsInitialized((Class)RemoveWatchpoint_Res.class, (Class)Builder.class);
    }
    ...
    private void b() {
        try {
            if (RemoveWatchpoint_Res.access$34100()) {
                this.c();
            }
        }
    ...
    public RemoveWatchpoint_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    RemoveWatchpoint_Res.access$34302(removeWatchpoint_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            RemoveWatchpoint_Res.access$34302(removeWatchpoint_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        RemoveWatchpoint_Res.access$34402(removeWatchpoint_Res, n);
        this.onBuilt();
