...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements Kill_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$10300();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$10400().ensureFieldAccessorsInitialized((Class)Kill_Res.class, (Class)Builder.class);
    }
    ...
    public Kill_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    Kill_Res.access$11002(kill_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            Kill_Res.access$11002(kill_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        Kill_Res.access$11102(kill_Res, n);
        this.onBuilt();
        return kill_Res;
    }
