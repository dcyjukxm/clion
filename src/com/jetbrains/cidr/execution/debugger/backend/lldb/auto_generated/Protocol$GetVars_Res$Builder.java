...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements GetVars_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$47200();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$47300().ensureFieldAccessorsInitialized((Class)GetVars_Res.class, (Class)Builder.class);
    }
            ...
            Label_0131: {
                Label_0090: {
                    Label_0066: {
                        try {
                            if (this.commonResponseBuilder_ == null) {
                                GetVars_Res.access$47902(getVars_Res, this.commonResponse_);
                                break Label_0066;
                            }
                        }
                        catch (NullPointerException ex) {
                        ...
                        GetVars_Res.access$47902(getVars_Res, (CommonResponse)this.commonResponseBuilder_.build());
                        try {
                            if (this.valueBuilder_ != null) {
                                break Label_0131;
                            }
                ...
                GetVars_Res.access$48002(getVars_Res, this.value_);
                break Label_0143;
            }
            GetVars_Res.access$48002(getVars_Res, this.valueBuilder_.build());
        }
        GetVars_Res.access$48102(getVars_Res, n);
        this.onBuilt();
        return getVars_Res;
    }
