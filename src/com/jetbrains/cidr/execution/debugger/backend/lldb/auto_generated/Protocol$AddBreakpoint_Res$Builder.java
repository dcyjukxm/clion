...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements AddBreakpoint_ResOrBuilder
{
    ...
    private void b() {
        try {
            if (AddBreakpoint_Res.access$23300()) {
                this.c();
            }
        }
    ...
    public AddBreakpoint_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    AddBreakpoint_Res.access$23502(addBreakpoint_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            AddBreakpoint_Res.access$23502(addBreakpoint_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        if ((bitField0_ & 0x2) == 0x2) {
            n |= 0x2;
        }
        AddBreakpoint_Res.access$23602(addBreakpoint_Res, this.id_);
        AddBreakpoint_Res.access$23702(addBreakpoint_Res, n);
        this.onBuilt();
