...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements Launch_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$4200();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$4300().ensureFieldAccessorsInitialized((Class)Launch_Res.class, (Class)Builder.class);
    }
    ...
    public Launch_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    Launch_Res.access$4902(launch_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            Launch_Res.access$4902(launch_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        if ((bitField0_ & 0x2) == 0x2) {
            n |= 0x2;
        }
        Launch_Res.access$5002(launch_Res, this.pid_);
        Launch_Res.access$5102(launch_Res, n);
        this.onBuilt();
        return launch_Res;
    }
