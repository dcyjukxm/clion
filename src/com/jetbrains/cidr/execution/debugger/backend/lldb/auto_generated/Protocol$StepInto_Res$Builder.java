...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements StepInto_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$24700();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$24800().ensureFieldAccessorsInitialized((Class)StepInto_Res.class, (Class)Builder.class);
    }
    ...
    public StepInto_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    StepInto_Res.access$25402(stepInto_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            StepInto_Res.access$25402(stepInto_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        StepInto_Res.access$25502(stepInto_Res, n);
        this.onBuilt();
        return stepInto_Res;
    }
