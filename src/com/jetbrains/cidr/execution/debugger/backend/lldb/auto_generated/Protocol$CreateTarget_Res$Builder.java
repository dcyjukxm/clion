...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements CreateTarget_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$2300();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$2400().ensureFieldAccessorsInitialized((Class)CreateTarget_Res.class, (Class)Builder.class);
    }
    ...
    private void b() {
        try {
            if (CreateTarget_Res.access$2800()) {
                this.a();
            }
        }
    ...
    public CreateTarget_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    CreateTarget_Res.access$3002(createTarget_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            CreateTarget_Res.access$3002(createTarget_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        CreateTarget_Res.access$3102(createTarget_Res, n);
        this.onBuilt();
