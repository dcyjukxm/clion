...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements Continue_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$12800();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$12900().ensureFieldAccessorsInitialized((Class)Continue_Res.class, (Class)Builder.class);
    }
    ...
    public Continue_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    Continue_Res.access$13502(continue_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            Continue_Res.access$13502(continue_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        Continue_Res.access$13602(continue_Res, n);
        this.onBuilt();
        return continue_Res;
    }
