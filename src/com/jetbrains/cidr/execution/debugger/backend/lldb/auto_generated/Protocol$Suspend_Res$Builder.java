...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements Suspend_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$14400();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$14500().ensureFieldAccessorsInitialized((Class)Suspend_Res.class, (Class)Builder.class);
    }
    ...
    public Suspend_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    Suspend_Res.access$15102(suspend_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            Suspend_Res.access$15102(suspend_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        Suspend_Res.access$15202(suspend_Res, n);
        this.onBuilt();
        return suspend_Res;
    }
