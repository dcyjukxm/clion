...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements RemoveBreakpoint_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$21900();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$22000().ensureFieldAccessorsInitialized((Class)RemoveBreakpoint_Res.class, (Class)Builder.class);
    }
    ...
    private void b() {
        try {
            if (RemoveBreakpoint_Res.access$22400()) {
                this.a();
            }
        }
    ...
    public RemoveBreakpoint_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    RemoveBreakpoint_Res.access$22602(removeBreakpoint_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            RemoveBreakpoint_Res.access$22602(removeBreakpoint_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        RemoveBreakpoint_Res.access$22702(removeBreakpoint_Res, n);
        this.onBuilt();
