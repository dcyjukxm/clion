...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements AddWatchpoint_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$34500();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$34600().ensureFieldAccessorsInitialized((Class)AddWatchpoint_Res.class, (Class)Builder.class);
    }
    ...
    private void b() {
        try {
            if (AddWatchpoint_Res.access$35000()) {
                this.a();
            }
        }
    ...
    public AddWatchpoint_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    AddWatchpoint_Res.access$35202(addWatchpoint_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            AddWatchpoint_Res.access$35202(addWatchpoint_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        if ((bitField0_ & 0x2) == 0x2) {
            n |= 0x2;
        }
        AddWatchpoint_Res.access$35302(addWatchpoint_Res, this.watchpointId_);
        AddWatchpoint_Res.access$35402(addWatchpoint_Res, n);
        this.onBuilt();
