            ...
            Label_0131: {
                Label_0090: {
                    Label_0066: {
                        try {
                            if (this.commonResponseBuilder_ == null) {
                                GetFrames_Res.access$19002(getFrames_Res, this.commonResponse_);
                                break Label_0066;
                            }
                        }
                        catch (NullPointerException ex) {
                        ...
                        GetFrames_Res.access$19002(getFrames_Res, (CommonResponse)this.commonResponseBuilder_.build());
                        try {
                            if (this.frameBuilder_ != null) {
                                break Label_0131;
                            }
                ...
                GetFrames_Res.access$19102(getFrames_Res, this.frame_);
                break Label_0143;
            }
            GetFrames_Res.access$19102(getFrames_Res, this.frameBuilder_.build());
        }
        if ((bitField0_ & 0x4) == 0x4) {
            n |= 0x2;
        }
        GetFrames_Res.access$19202(getFrames_Res, this.hasMore_);
        GetFrames_Res.access$19302(getFrames_Res, n);
        this.onBuilt();
