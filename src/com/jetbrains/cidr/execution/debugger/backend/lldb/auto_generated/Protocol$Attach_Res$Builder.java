...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements Attach_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$11200();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$11300().ensureFieldAccessorsInitialized((Class)Attach_Res.class, (Class)Builder.class);
    }
    ...
    public Attach_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    Attach_Res.access$11902(attach_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            Attach_Res.access$11902(attach_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        Attach_Res.access$12002(attach_Res, n);
        this.onBuilt();
        return attach_Res;
    }
