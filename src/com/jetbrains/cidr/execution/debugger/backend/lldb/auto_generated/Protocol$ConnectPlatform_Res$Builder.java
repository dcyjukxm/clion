...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements ConnectPlatform_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$57300();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$57400().ensureFieldAccessorsInitialized((Class)ConnectPlatform_Res.class, (Class)Builder.class);
    }
    ...
    private void a() {
        try {
            if (ConnectPlatform_Res.access$57800()) {
                this.c();
            }
        }
    ...
    public ConnectPlatform_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    ConnectPlatform_Res.access$58002(connectPlatform_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            ConnectPlatform_Res.access$58002(connectPlatform_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        ConnectPlatform_Res.access$58102(connectPlatform_Res, n);
        this.onBuilt();
