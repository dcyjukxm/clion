...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements AttachByName_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$6200();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$6300().ensureFieldAccessorsInitialized((Class)AttachByName_Res.class, (Class)Builder.class);
    }
    ...
    private void a() {
        try {
            if (AttachByName_Res.access$6700()) {
                this.c();
            }
        }
    ...
    public AttachByName_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    AttachByName_Res.access$6902(attachByName_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            AttachByName_Res.access$6902(attachByName_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        AttachByName_Res.access$7002(attachByName_Res, n);
        this.onBuilt();
