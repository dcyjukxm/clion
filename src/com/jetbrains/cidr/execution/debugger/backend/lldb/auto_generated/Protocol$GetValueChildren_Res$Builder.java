...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements GetValueChildren_ResOrBuilder
{
    ...
    private void a() {
        try {
            if (GetValueChildren_Res.access$45400()) {
                this.b();
                this.c();
            }
        }
            ...
            Label_0131: {
                Label_0090: {
                    Label_0066: {
                        try {
                            if (this.commonResponseBuilder_ == null) {
                                GetValueChildren_Res.access$45602(getValueChildren_Res, this.commonResponse_);
                                break Label_0066;
                            }
                        }
                        catch (NullPointerException ex) {
                        ...
                        GetValueChildren_Res.access$45602(getValueChildren_Res, (CommonResponse)this.commonResponseBuilder_.build());
                        try {
                            if (this.valueBuilder_ != null) {
                                break Label_0131;
                            }
                ...
                GetValueChildren_Res.access$45702(getValueChildren_Res, this.value_);
                break Label_0143;
            }
            GetValueChildren_Res.access$45702(getValueChildren_Res, this.valueBuilder_.build());
        }
        GetValueChildren_Res.access$45802(getValueChildren_Res, n);
        this.onBuilt();
