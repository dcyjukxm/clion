...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements GetValueData_ResOrBuilder
{
    ...
    private void a() {
        try {
            if (GetValueData_Res.access$40400()) {
                this.b();
                this.c();
            }
        }
    ...
    public GetValueData_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    GetValueData_Res.access$40602(getValueData_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            GetValueData_Res.access$40602(getValueData_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        ...
        Label_0115: {
            try {
                if (this.valueBuilder_ == null) {
                    GetValueData_Res.access$40702(getValueData_Res, this.value_);
                    break Label_0115;
                }
            }
            catch (NullPointerException ex2) {
            ...
            GetValueData_Res.access$40702(getValueData_Res, (Model.LLDBValueData)this.valueBuilder_.build());
        }
        GetValueData_Res.access$40802(getValueData_Res, n);
        this.onBuilt();
