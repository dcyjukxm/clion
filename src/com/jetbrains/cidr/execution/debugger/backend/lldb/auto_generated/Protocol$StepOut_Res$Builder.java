...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements StepOut_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$28300();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$28400().ensureFieldAccessorsInitialized((Class)StepOut_Res.class, (Class)Builder.class);
    }
    ...
    public StepOut_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    StepOut_Res.access$29002(stepOut_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            StepOut_Res.access$29002(stepOut_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        StepOut_Res.access$29102(stepOut_Res, n);
        this.onBuilt();
        return stepOut_Res;
    }
