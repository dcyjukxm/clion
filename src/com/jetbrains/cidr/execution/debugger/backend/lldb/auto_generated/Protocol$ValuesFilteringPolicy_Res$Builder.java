...
public static final class Builder extends GeneratedMessage.Builder<Builder> implements ValuesFilteringPolicy_ResOrBuilder
{
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return Protocol.access$55400();
    }
    
    protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return Protocol.access$55500().ensureFieldAccessorsInitialized((Class)ValuesFilteringPolicy_Res.class, (Class)Builder.class);
    }
    ...
    private void b() {
        try {
            if (ValuesFilteringPolicy_Res.access$55900()) {
                this.c();
            }
        }
    ...
    public ValuesFilteringPolicy_Res buildPartial() {
        ...
        Label_0066: {
            try {
                if (this.commonResponseBuilder_ == null) {
                    ValuesFilteringPolicy_Res.access$56102(valuesFilteringPolicy_Res, this.commonResponse_);
                    break Label_0066;
                }
            }
            catch (NullPointerException ex) {
            ...
            ValuesFilteringPolicy_Res.access$56102(valuesFilteringPolicy_Res, (CommonResponse)this.commonResponseBuilder_.build());
        }
        ValuesFilteringPolicy_Res.access$56202(valuesFilteringPolicy_Res, n);
        this.onBuilt();
