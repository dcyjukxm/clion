...
import com.jetbrains.cidr.lang.refactoring.move.ui.OCExtractCategoryDialog;
...
public class OCExtractCategoryHandler extends OCMoveRefactoringHandler
{
    @Override
    ...
    protected OCAbstractMoveDialog createDialog(final OCSymbolDeclarator ocSymbolDeclarator, final OCSymbol ocSymbol, final Condition<PsiElement> condition, final Editor editor) {
        return new OCExtractCategoryDialog(ocSymbolDeclarator, ocSymbol, condition);
    }
    ...
    protected String getFeatureID() {
        String s;
        try {
            s = "refactoring.extractCategory";
            if (s == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/lang/refactoring/move/handlers/OCExtractCategoryHandler", "getFeatureID"));
            }
        }
        catch (IllegalStateException ex) {
            throw a(ex);
    ...
    protected boolean acceptsElement(final PsiElement p0) {
        ...
        //    28: ifeq            46
        //    31: goto            38
        //    34: invokestatic    com/jetbrains/cidr/lang/refactoring/move/handlers/OCExtractCategoryHandler.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    37: athrow         
        //    38: iconst_1       
        //    39: goto            47
        //    42: invokestatic    com/jetbrains/cidr/lang/refactoring/move/handlers/OCExtractCategoryHandler.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    45: athrow         
        //    46: iconst_0       
        //    47: ireturn        
        //    48: aload_1        
        ...
        //    59: ifne            83
        //    62: goto            69
        //    65: invokestatic    com/jetbrains/cidr/lang/refactoring/move/handlers/OCExtractCategoryHandler.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    68: athrow         
        //    69: aload_1        
        //    70: instanceof      Lcom/jetbrains/cidr/lang/psi/OCProperty;
        //    73: ifeq            91
        //    76: goto            83
        //    79: invokestatic    com/jetbrains/cidr/lang/refactoring/move/handlers/OCExtractCategoryHandler.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    82: athrow         
        //    83: iconst_1       
        //    84: goto            92
        //    87: invokestatic    com/jetbrains/cidr/lang/refactoring/move/handlers/OCExtractCategoryHandler.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    90: athrow         
        //    91: iconst_0       
        //    92: ireturn        
        //    Exceptions:
