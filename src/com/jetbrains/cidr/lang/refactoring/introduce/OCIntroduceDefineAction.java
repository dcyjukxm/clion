...
public class OCIntroduceDefineAction extends OCBaseIntroduceAction
{
    @Override
    public RefactoringActionHandler getHandler() {
        return (RefactoringActionHandler)new OCBaseIntroduceHandler<OCElement>("an element", "Introduce Define", new Class[] { OCElement.class }) {
            @Override
