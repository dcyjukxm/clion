...
public class OCIntroduceParameterAction extends OCBaseIntroduceAction
{
    @Override
    public RefactoringActionHandler getHandler() {
        return (RefactoringActionHandler)new OCBaseLocalConvertibleHandler("Introduce Parameter") {
            @Override
