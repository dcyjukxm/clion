...
public class OCIntroduceConstantAction extends OCBaseIntroduceAction
{
    @Override
    public RefactoringActionHandler getHandler() {
        return (RefactoringActionHandler)new OCBaseIntroduceHandler<OCExpression>("an expression", "Introduce Constant", new Class[] { OCExpression.class }) {
            @Override
