...
public class OCIntroduceTypedefAction extends OCBaseIntroduceAction
{
    @Override
    public RefactoringActionHandler getHandler() {
        return (RefactoringActionHandler)new OCBaseIntroduceHandler<PsiElement>("a type or a declarator", "Introduce Typedef", new Class[] { OCTypeElement.class, OCDeclaration.class, OCDeclarator.class, OCReferenceElement.class, OCCppNamespaceQualifier.class }) {
            @Override
