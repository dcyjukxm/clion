...
public class OCMoveToInterfaceIntentionAction extends OCDeclareMembersHandler implements IntentionAction
{
    @NotNull
    ...
    public boolean isAvailable(@NotNull final Project p0, final Editor p1, final PsiFile p2) {
        ...
        //    21: dup            
        //    22: ldc             1
        //    24: ldc             "com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction"
        //    26: aastore        
        //    27: dup            
        //    28: ldc             2
        //    30: ldc             "isAvailable"
        ...
        //    39: athrow         
        //    40: invokestatic    com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    43: athrow         
        //    44: aload_0        
        //    45: aload_1        
        //    46: aload_2        
        //    47: aload_3        
        //    48: invokevirtual   com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction.locateCandidate:(Lcom/intellij/openapi/project/Project;Lcom/intellij/openapi/editor/Editor;Lcom/intellij/psi/PsiFile;)Lcom/jetbrains/cidr/lang/symbols/objc/OCMemberSymbol;
        //    51: astore          4
        //    53: aload           4
        //    55: ifnull          131
        //    58: aload           4
        ...
        //    68: ifeq            131
        //    71: goto            78
        //    74: invokestatic    com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    77: athrow         
        //    78: aload           4
        ...
        //    83: ifeq            131
        //    86: goto            93
        //    89: invokestatic    com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //    92: athrow         
        //    93: ldc             ""
        //    95: aload           4
        ...
        //   113: ifeq            131
        //   116: goto            123
        //   119: invokestatic    com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //   122: athrow         
        //   123: iconst_1       
        //   124: goto            132
        //   127: invokestatic    com/jetbrains/cidr/lang/intentions/OCMoveToInterfaceIntentionAction.a:(Ljava/lang/IllegalStateException;)Ljava/lang/IllegalStateException;
        //   130: athrow         
        //   131: iconst_0       
        //   132: ireturn        
        //    Exceptions:
