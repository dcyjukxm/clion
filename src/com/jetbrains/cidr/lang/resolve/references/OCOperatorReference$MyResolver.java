    ...
    public Pair<List<OCSymbol>, Boolean> resolve(@NotNull final OCOperatorReference ocOperatorReference, @NotNull final OCResolveContext ocResolveContext) {
        ...
        try {
            if (ocOperatorReference.myArguments != null) {
                return this.b(OCOperatorReference.access$000(ocOperatorReference), OCOperatorReference.access$100(ocOperatorReference), OCOperatorReference.access$200(ocOperatorReference), ocOperatorReference.myArguments, ocResolveContext, ocOperatorReference.getElement());
            }
        }
        catch (IllegalArgumentException ex3) {
            throw a(ex3);
        }
        return (Pair<List<OCSymbol>, Boolean>)Pair.create((Object)this.a(OCOperatorReference.access$000(ocOperatorReference), OCOperatorReference.access$100(ocOperatorReference), OCOperatorReference.access$200(ocOperatorReference), null, ocResolveContext, ocOperatorReference.getElement()), (Object)false);
    }
