...
public class OCSimplifyInspection extends OCInspections.GeneralCpp
{
    private static Key<Map<PsiElement, Pair<PsiElement, Simplifier>>> SIMPLIFIABLE_ELEMENTS;
    public boolean enableSimplifyEqualToYesNo;
    public boolean enableSimplifyIfWithConstantBranch;
    private static Set<String> GOOD_MACROS;
    static final /* synthetic */ boolean $assertionsDisabled;
    
    public OCSimplifyInspection() {
        this.enableSimplifyEqualToYesNo = true;
        this.enableSimplifyIfWithConstantBranch = false;
    }
    
    public JComponent createOptionsPanel() {
        final JPanel panel = new JPanel((LayoutManager)new VerticalFlowLayout());
        final CheckBox checkBox = new CheckBox("Simplify \"condition == true\"", (InspectionProfileEntry)this, "enableSimplifyEqualToYesNo");
        final CheckBox checkBox2 = new CheckBox("Simplify \"condition1 ? true : condition2\"", (InspectionProfileEntry)this, "enableSimplifyIfWithConstantBranch");
    ...
    @NotNull
    public PsiElementVisitor buildVisitor(@NotNull final ProblemsHolder problemsHolder, final boolean b, @NotNull final LocalInspectionToolSession localInspectionToolSession) {
        try {
        ...
        try {
            localInspectionToolSession.putUserData((Key)OCSimplifyInspection.SIMPLIFIABLE_ELEMENTS, (Object)hashMap);
            simplifyVisitor = new SimplifyVisitor() {
                @Override
                protected void simplify(@NotNull final PsiElement psiElement, final PsiElement psiElement2, final Simplifier simplifier) {
                    ...
                    try {
                        if (psiElement2 != null) {
                            hashMap.put(psiElement, Pair.create((Object)psiElement2, (Object)simplifier));
                        }
                    }
    ...
    public static void simplify(final PsiElement psiElement) {
        psiElement.accept((PsiElementVisitor)new SimplifyVisitor() {
            @Override
    ...
    public void inspectionFinished(@NotNull final LocalInspectionToolSession localInspectionToolSession, @NotNull final ProblemsHolder problemsHolder) {
        ...
        final Map map = (Map)localInspectionToolSession.getUserData((Key)OCSimplifyInspection.SIMPLIFIABLE_ELEMENTS);
        Label_0116: {
            try {
                if (OCSimplifyInspection.$assertionsDisabled) {
                    break Label_0116;
                }
                final Map map2 = map;
                if (map2 == null) {
    ...
    Label_0141:
        for (final PsiElement psiElement : map.keySet()) {
            ...
            for (PsiElement psiElement2 = psiElement.getParent(); psiElement2 != null; psiElement2 = psiElement2.getParent()) {
                final Pair pair = (Pair)map.get(psiElement2);
                Label_0232: {
                    try {
                        if (pair == null) {
                            continue;
                        ...
                        final Object o = pair2.getSecond();
                        final Simplifier simplifier = (Simplifier)o;
                        final OCSimplifyInspection ocSimplifyInspection = this;
                        final boolean b = simplifier.isWarningDisabled(ocSimplifyInspection);
                        if (!b) {
                            break Label_0232;
                        }
                        continue;
            ...
            final Pair pair3 = (Pair)map.get(psiElement);
            final PsiElement psiElement3 = (PsiElement)pair3.getFirst();
            Object o2;
            if (psiElement instanceof OCIfStatement) {
                o2 = ((OCIfStatement)psiElement).getCondition();
            }
            else if (psiElement instanceof OCLoopStatement) {
                o2 = ((OCLoopStatement)psiElement).getCondition();
            }
            else {
                o2 = psiElement;
            }
            final String simplifyMessage = getSimplifyMessage(psiElement, psiElement3);
            final IntentionAction simplifyFix = getSimplifyFix(psiElement, psiElement3);
            ProblemHighlightType problemHighlightType = null;
            Label_0370: {
                try {
                    if (((Simplifier)pair3.getSecond()).isWarningDisabled(this)) {
            ...
            this.registerProblem(problemsHolder, null, null, problemsHolder.isOnTheFly(), (PsiElement)o2, simplifyMessage, "CIDR", problemHighlightType, simplifyFix);
        }
    }
    
    public static String getSimplifyMessage(final PsiElement p0, final PsiElement p1) {
        // 
        ...
        //     4: ifeq            119
        //     7: aload_0        
        //     8: checkcast       Lcom/jetbrains/cidr/lang/psi/OCIfStatement;
        //    11: invokeinterface com/jetbrains/cidr/lang/psi/OCIfStatement.getThenBranch:()Lcom/jetbrains/cidr/lang/psi/OCStatement;
        //    16: astore_2       
        //    17: aload_0        
        //    18: checkcast       Lcom/jetbrains/cidr/lang/psi/OCIfStatement;
        //    21: invokeinterface com/jetbrains/cidr/lang/psi/OCIfStatement.getElseBranch:()Lcom/jetbrains/cidr/lang/psi/OCStatement;
        //    26: astore_3       
        //    27: aload_1        
        //    28: aload_2        
        //    29: if_acmpne       90
        ...
        //    33: ifnull          87
        //    36: goto            43
        //    39: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    42: athrow         
        //    43: aload_3        
        //    44: ifnull          87
        //    47: goto            54
        //    50: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    53: athrow         
        //    54: aload_2        
        //    55: aload_3        
        //    56: iconst_0       
        //    57: new             Lcom/jetbrains/cidr/lang/symbols/OCResolveContext;
        //    60: dup            
        //    61: aload_0        
        //    62: invokespecial   com/jetbrains/cidr/lang/symbols/OCResolveContext.<init>:(Lcom/intellij/psi/PsiElement;)V
        //    65: invokestatic    com/jetbrains/cidr/lang/util/OCElementUtil.areElementsEquivalent:(Lcom/intellij/psi/PsiElement;Lcom/intellij/psi/PsiElement;ZLcom/jetbrains/cidr/lang/symbols/OCResolveContext;)Z
        //    68: ifeq            87
        //    71: goto            78
        //    74: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    77: athrow         
        //    78: ldc             "'if' statement has identical branches"
        //    80: goto            89
        //    83: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    86: athrow         
        //    87: ldc             "Condition is always true"
        //    89: areturn        
        //    90: aload_1        
        //    91: aload_3        
        //    92: if_acmpeq       109
        //    95: aload_1        
        //    96: instanceof      Lcom/jetbrains/cidr/lang/psi/OCEmptyStatement;
        //    99: ifeq            116
        //   102: goto            109
        //   105: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   108: athrow         
        //   109: ldc             "Condition is always false"
        //   111: areturn        
        //   112: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   115: athrow         
        //   116: ldc             "Statement can be simplified"
        //   118: areturn        
        //   119: aload_0        
        //   120: instanceof      Lcom/jetbrains/cidr/lang/psi/OCLoopStatement;
        //   123: ifeq            133
        //   126: ldc             "Condition is always false"
        //   128: areturn        
        //   129: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   132: athrow         
        //   133: new             Ljava/lang/StringBuilder;
        //   136: dup            
        //   137: invokespecial   java/lang/StringBuilder.<init>:()V
        //   140: ldc             "Expression can be simplified to '"
        //   142: invokevirtual   java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
        //   145: aload_1        
        //   146: invokestatic    com/jetbrains/cidr/lang/util/OCElementUtil.getTextWithMacros:(Lcom/intellij/psi/PsiElement;)Ljava/lang/String;
        ...
        //  -----  -----  -----  -----  -----------------------------------------
        //  27     36     39     43     Ljava/lang/UnsupportedOperationException;
        //  32     47     50     54     Ljava/lang/UnsupportedOperationException;
        //  43     71     74     78     Ljava/lang/UnsupportedOperationException;
        //  54     83     83     87     Ljava/lang/UnsupportedOperationException;
        //  90     102    105    109    Ljava/lang/UnsupportedOperationException;
        //  95     112    112    116    Ljava/lang/UnsupportedOperationException;
        //  119    129    129    133    Ljava/lang/UnsupportedOperationException;
        // 
    ...
    public static IntentionAction getSimplifyFix(final PsiElement p0, final PsiElement p1) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        // 
        //     0: aload_0        
        //     1: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.a:(Lcom/intellij/psi/PsiElement;)Ljava/lang/String;
        //     4: astore_2       
        //     5: aload_0        
        //     6: instanceof      Lcom/jetbrains/cidr/lang/psi/OCStatement;
        //     9: ifeq            86
        //    12: aload_0        
        //    13: invokeinterface com/intellij/psi/PsiElement.getParent:()Lcom/intellij/psi/PsiElement;
        //    18: instanceof      Lcom/jetbrains/cidr/lang/psi/OCBlockStatement;
        //    21: ifeq            86
        //    24: goto            31
        //    27: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    30: athrow         
        //    31: aload_1        
        //    32: instanceof      Lcom/jetbrains/cidr/lang/psi/OCBlockStatement;
        //    35: ifeq            86
        //    38: goto            45
        //    41: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    44: athrow         
        //    45: new             Lcom/jetbrains/cidr/lang/quickfixes/OCChangeElementIntentionAction;
        //    48: dup            
        //    49: aload_0        
        //    50: aload_1        
        //    51: checkcast       Lcom/jetbrains/cidr/lang/psi/OCBlockStatement;
        //    54: invokeinterface com/jetbrains/cidr/lang/psi/OCBlockStatement.getStatements:()Ljava/util/List;
        ...
        //    78: invokespecial   com/jetbrains/cidr/lang/quickfixes/OCChangeElementIntentionAction.<init>:(Lcom/intellij/psi/PsiElement;Ljava/util/List;Ljava/lang/String;)V
        //    81: areturn        
        //    82: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    85: athrow         
        //    86: aload_1        
        //    87: instanceof      Lcom/jetbrains/cidr/lang/psi/OCEmptyStatement;
        //    90: ifeq            125
        //    93: new             Lcom/jetbrains/cidr/lang/quickfixes/OCRemoveElementsIntentionAction;
        //    96: dup            
        //    97: aload_0        
        ...
        //   117: invokespecial   com/jetbrains/cidr/lang/quickfixes/OCRemoveElementsIntentionAction.<init>:(Lcom/intellij/psi/PsiElement;Ljava/lang/String;)V
        //   120: areturn        
        //   121: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   124: athrow         
        //   125: aload_1        
        //   126: instanceof      Lcom/jetbrains/cidr/lang/psi/OCExpression;
        //   129: ifeq            161
        //   132: aload_0        
        //   133: instanceof      Lcom/jetbrains/cidr/lang/psi/OCIfStatement;
        //   136: ifeq            161
        //   139: goto            146
        //   142: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   145: athrow         
        //   146: new             Lcom/jetbrains/cidr/lang/inspections/OCSimplifyInspection$3;
        //   149: dup            
        //   150: aload_2        
        //   151: aload_0        
        //   152: aload_1        
        //   153: invokespecial   com/jetbrains/cidr/lang/inspections/OCSimplifyInspection$3.<init>:(Ljava/lang/String;Lcom/intellij/psi/PsiElement;Lcom/intellij/psi/PsiElement;)V
        //   156: areturn        
        //   157: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   160: athrow         
        //   161: new             Lcom/jetbrains/cidr/lang/quickfixes/OCChangeElementIntentionAction;
        //   164: dup            
        //   165: aload_0        
        //   166: aload_1        
        ...
        //   179: aload_0        
        //   180: instanceof      Lcom/jetbrains/cidr/lang/psi/OCExpression;
        //   183: ifeq            195
        //   186: ldc             "expression"
        //   188: goto            196
        //   191: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //   194: athrow         
        //   195: aload_2        
        ...
        //   202: invokespecial   com/jetbrains/cidr/lang/quickfixes/OCChangeElementIntentionAction.<init>:(Lcom/intellij/psi/PsiElement;Lcom/intellij/psi/PsiElement;Ljava/lang/String;)V
        //   205: areturn        
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type                                     
        //  -----  -----  -----  -----  -----------------------------------------
        //  5      24     27     31     Ljava/lang/UnsupportedOperationException;
        //  12     38     41     45     Ljava/lang/UnsupportedOperationException;
        //  31     82     82     86     Ljava/lang/UnsupportedOperationException;
        //  86     121    121    125    Ljava/lang/UnsupportedOperationException;
        //  125    139    142    146    Ljava/lang/UnsupportedOperationException;
        //  132    157    157    161    Ljava/lang/UnsupportedOperationException;
        //  161    191    191    195    Ljava/lang/UnsupportedOperationException;
        // 
        // The error that occurred was:
        // 
    ...
    @Nullable
    public static OCStatement simplifyStatementWithConstCondition(final boolean b, @NotNull final OCStatement ocStatement) {
        try {
            if (ocStatement == null) {
        ...
        if (ocStatement instanceof OCIfStatement) {
            final OCStatement thenBranch = ((OCIfStatement)ocStatement).getThenBranch();
            final OCStatement elseBranch = ((OCIfStatement)ocStatement).getElseBranch();
            try {
                if (b) {
                    return thenBranch;
                }
            ...
            return c((PsiElement)ocStatement);
        }
        Label_0167: {
            Label_0149: {
                Label_0131: {
                    Label_0118: {
                        try {
                            if (!(ocStatement instanceof OCWhileStatement)) {
                                break Label_0131;
                            }
                            final boolean b2 = b;
                            if (b2) {
                    ...
                    return c((PsiElement)ocStatement);
                    try {
                        if (!(ocStatement instanceof OCDoWhileStatement)) {
                            break Label_0167;
                        }
                        final boolean b3 = b;
                        if (b3) {
                        ...
                        return ((OCDoWhileStatement)ocStatement).getBody();
                    }
                    catch (UnsupportedOperationException ex6) {
                        throw b(ex6);
                    }
        ...
        if (ocStatement instanceof OCForStatement) {
            final OCStatement initializer = ((OCForStatement)ocStatement).getInitializer();
            try {
                if (b) {
                    return null;
                }
        ...
        throw new UnsupportedOperationException(ocStatement.getClass().getCanonicalName());
    }
    
    @Nullable
    public static OCExpression simplifyLogicExpression(final boolean b, @NotNull final OCBinaryExpression ocBinaryExpression, final PsiElement psiElement) {
        try {
        ...
        if (PsiTreeUtil.isAncestor((PsiElement)ocBinaryExpression.getLeft(), psiElement, false)) {
            ocExpression = ocBinaryExpression.getRight();
        }
        else {
            if (!PsiTreeUtil.isAncestor((PsiElement)ocBinaryExpression.getRight(), psiElement, false)) {
                return null;
            }
            ocExpression = ocBinaryExpression.getLeft();
        }
        return a(b, ocBinaryExpression.getLeft(), ocExpression, operationSign);
    }
    
    private static OCStatement c(final PsiElement psiElement) {
        return OCElementFactory.statementFromText(";", psiElement);
    }
    
    @Nullable
    private static OCExpression b(@Nullable final OCExpression ocExpression) {
        ...
        Label_0026: {
            try {
                ...
                final boolean b = a(ocExpression3);
                if (b) {
                    return ocExpression;
                }
                break Label_0026;
        ...
        Label_0154: {
            if (ocExpression instanceof OCConditionalExpression) {
                final OCConditionalExpression ocConditionalExpression = (OCConditionalExpression)ocExpression;
                ocExpression2 = new Simplifier().a(ocConditionalExpression.getCondition(), ocConditionalExpression.getPositiveExpression(true), ocConditionalExpression.getNegativeExpression());
            }
            else if (ocExpression instanceof OCBinaryExpression) {
                ocExpression2 = new Simplifier().a((OCBinaryExpression)ocExpression);
            }
            else if (ocExpression instanceof OCUnaryExpression) {
                ocExpression2 = a((OCUnaryExpression)ocExpression);
            }
            else {
                try {
                    if (!(ocExpression instanceof OCParenthesizedExpression) || OCElementUtil.isPartOfMacroSubstitution((PsiElement)ocExpression)) {
                        break Label_0154;
                    }
                }
                catch (UnsupportedOperationException ex3) {
                ...
                ocExpression2 = b(((OCParenthesizedExpression)ocExpression).getOperand());
            }
            try {
    ...
    private static boolean b(final PsiElement p0) {
        ...
        // 
        //     0: aload_0        
        //     1: invokeinterface com/intellij/psi/PsiElement.getChildren:()[Lcom/intellij/psi/PsiElement;
        //     6: astore_1       
        //     7: aload_1        
        //     8: arraylength    
        //     9: istore_2       
        ...
        //    27: ifeq            58
        //    30: getstatic       com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.GOOD_MACROS:Ljava/util/Set;
        //    33: aload           4
        //    35: checkcast       Lcom/jetbrains/cidr/lang/psi/OCMacroCall;
        //    38: invokeinterface com/jetbrains/cidr/lang/psi/OCMacroCall.getTextWithMacros:()Ljava/lang/String;
        //    43: invokeinterface java/util/Set.contains:(Ljava/lang/Object;)Z
        //    48: ifeq            73
        //    51: goto            58
        //    54: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    57: athrow         
        //    58: aload           4
        //    60: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Lcom/intellij/psi/PsiElement;)Z
        //    63: ifeq            79
        //    66: goto            73
        //    69: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    72: athrow         
        //    73: iconst_1       
        //    74: ireturn        
        //    75: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    78: athrow         
        //    79: iinc            3, 1
        //    82: goto            12
        //    85: iconst_0       
        ...
        //  Start  End    Start  End    Type                                     
        //  -----  -----  -----  -----  -----------------------------------------
        //  22     51     54     58     Ljava/lang/UnsupportedOperationException;
        //  30     66     69     73     Ljava/lang/UnsupportedOperationException;
        //  58     75     75     79     Ljava/lang/UnsupportedOperationException;
        // 
        // The error that occurred was:
        // 
    ...
    @Nullable
    private static <T> T a(final T p0, final PsiElement p1) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //     4: ifeq            63
        //     7: aload_1        
        //     8: invokestatic    com/jetbrains/cidr/lang/util/OCElementUtil.getRangeInMacroCall:(Lcom/intellij/psi/PsiElement;)Lcom/jetbrains/cidr/lang/parser/OCMacroRange;
        //    11: astore_2       
        //    12: aload_2        
        //    13: ifnull          63
        //    16: aload_2        
        //    17: invokevirtual   com/jetbrains/cidr/lang/parser/OCMacroRange.getMacroCall:()Lcom/jetbrains/cidr/lang/psi/OCMacroCall;
        //    20: ifnull          63
        //    23: goto            30
        //    26: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    29: athrow         
        //    30: getstatic       com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.GOOD_MACROS:Ljava/util/Set;
        //    33: aload_2        
        //    34: invokevirtual   com/jetbrains/cidr/lang/parser/OCMacroRange.getMacroCall:()Lcom/jetbrains/cidr/lang/psi/OCMacroCall;
        //    37: invokeinterface com/jetbrains/cidr/lang/psi/OCMacroCall.getTextWithMacros:()Ljava/lang/String;
        //    42: invokeinterface java/util/Set.contains:(Ljava/lang/Object;)Z
        //    47: ifne            63
        //    50: goto            57
        //    53: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    56: athrow         
        //    57: aconst_null    
        //    58: areturn        
        //    59: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        //    62: athrow         
        //    63: aload_1        
        //    64: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Lcom/intellij/psi/PsiElement;)Z
        //    67: ifeq            78
        //    70: aconst_null    
        //    71: goto            79
        //    74: invokestatic    com/jetbrains/cidr/lang/inspections/OCSimplifyInspection.b:(Ljava/lang/UnsupportedOperationException;)Ljava/lang/UnsupportedOperationException;
        ...
        //    79: areturn        
        //    Signature:
        //  <T:Ljava/lang/Object;>(TT;Lcom/intellij/psi/PsiElement;)TT;
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type                                     
        //  -----  -----  -----  -----  -----------------------------------------
        //  12     23     26     30     Ljava/lang/UnsupportedOperationException;
        //  16     50     53     57     Ljava/lang/UnsupportedOperationException;
        //  30     59     59     63     Ljava/lang/UnsupportedOperationException;
        //  63     74     74     78     Ljava/lang/UnsupportedOperationException;
        // 
        // The error that occurred was:
        // 
    ...
    static {
        ...
        Label_0017: {
            try {
                if (!OCSimplifyInspection.class.desiredAssertionStatus()) {
        ...
        OCSimplifyInspection.SIMPLIFIABLE_ELEMENTS = (Key<Map<PsiElement, Pair<PsiElement, Simplifier>>>)Key.create("SIMPLIFIABLE_ELEMENTS");
        OCSimplifyInspection.GOOD_MACROS = (Set<String>)ContainerUtil.set((Object[])new String[] { "YES", "NO", "true", "false", "TRUE", "FALSE" });
    }
        ...
        public void visitBinaryExpression(final OCBinaryExpression ocBinaryExpression) {
            Label_0026: {
                try {
                    ...
                    final boolean b = a(ocBinaryExpression2);
                    if (b) {
                        return;
                    }
                    break Label_0026;
        ...
        public void visitUnaryExpression(final OCUnaryExpression ocUnaryExpression) {
            Label_0026: {
                try {
                    ...
                    final boolean b = a(ocUnaryExpression2);
                    if (b) {
                        return;
                    }
                    break Label_0026;
    ...
    private static class Simplifier
    {
        ...
        private static PsiElement a(@NotNull final OCLoopStatement ocLoopStatement) {
            ...
            final Number n = (Number)a(OCExpressionEvaluator.evaluate((OCExpression)o), (PsiElement)o);
            Label_0128: {
                try {
                    if (n == null) {
                        return null;
        ...
        private static OCExpression a(@NotNull final OCUnaryExpression ocUnaryExpression) {
            ...
            final Number n = (Number)a(OCExpressionEvaluator.evaluate(operand), (PsiElement)operand);
            Label_0126: {
                Label_0110: {
                    try {
                        if (n == null) {
            ...
            if (diveIntoParentheses instanceof OCUnaryExpression) {
                ...
                Label_0229: {
                    ...
                    try {
                        final boolean b2 = instanceOfType;
                        if (!b2) {
                            return b(a(ocUnaryExpression3.getOperand()));
                        }
                    }
                ...
                try {
                    if (!(diveIntoParentheses instanceof OCBinaryExpression) || a(diveIntoParentheses)) {
                        return null;
                    }
                }
        ...
        private static OCExpression a(@Nullable OCExpression a, @Nullable OCExpression a2, @Nullable final OCElementType ocElementType) {
            ...
            a = a(a, precedence);
            a2 = a(a2, precedence);
            return b(OCElementFactory.binaryExpression((PsiElement)a, (PsiElement)a2, ocElementType));
        }
        ...
        private static OCExpression b(@Nullable OCExpression a) {
            ...
            return b(OCElementFactory.unaryExpression((PsiElement)a, OCTokenTypes.EXCL));
        }
