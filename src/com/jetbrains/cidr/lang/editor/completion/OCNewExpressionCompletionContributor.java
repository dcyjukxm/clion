...
public class OCNewExpressionCompletionContributor extends OCCompletionContributorBase
{
    public static final PsiElementPattern.Capture<PsiElement> TYPE_IN_NEW_EXPRESSION;
    
    public OCNewExpressionCompletionContributor() {
        this.register(CompletionType.BASIC, (ElementPattern<? extends PsiElement>)OCNewExpressionCompletionContributor.TYPE_IN_NEW_EXPRESSION, new InnerCompletionProvider());
        this.register(CompletionType.SMART, (ElementPattern<? extends PsiElement>)OCNewExpressionCompletionContributor.TYPE_IN_NEW_EXPRESSION, new InnerCompletionProvider());
    }
    ...
    static {
        TYPE_IN_NEW_EXPRESSION = (PsiElementPattern.Capture)PlatformPatterns.psiElement((IElementType)OCTokenTypes.IDENTIFIER).with((PatternCondition)new PatternCondition<PsiElement>("TYPE_IN_NEW_EXPRESSION") {
