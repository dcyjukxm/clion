...
public interface OCIncludeMap
{
    public static final OCIncludeMap EMPTY = new OCIncludeMap() {
        @Override
    ...
    @Nullable
    VirtualFile get(@NotNull final String p0, @NotNull final OCResolveRootAndConfiguration p1);
}
