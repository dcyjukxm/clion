...
public class OCFileExtensionsSettingsProvider extends CodeStyleSettingsProvider
{
    @NotNull
    public Configurable createSettingsPage(final CodeStyleSettings codeStyleSettings, final CodeStyleSettings codeStyleSettings2) {
        MyMasterDetailsComponent myMasterDetailsComponent;
        try {
            myMasterDetailsComponent = new MyMasterDetailsComponent(codeStyleSettings);
        ...
        return (Configurable)myMasterDetailsComponent;
    }
