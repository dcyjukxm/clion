...
public class OCBracesWhitesmithsCodeStyle extends OCPredefinedCodeStyleBase
{
    public OCBracesWhitesmithsCodeStyle() {
        super("Whitesmiths braces", "whitesmiths");
    }
    ...
    public void apply(@NotNull final CodeStyleSettings codeStyleSettings) {
        try {
            if (codeStyleSettings == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "settings", "com/jetbrains/cidr/lang/settings/formatter/OCBracesWhitesmithsCodeStyle", "apply"));
            }
        }
