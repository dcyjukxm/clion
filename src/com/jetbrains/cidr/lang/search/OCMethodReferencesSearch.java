...
public class OCMethodReferencesSearch implements QueryExecutor<PsiReference, ReferencesSearch.SearchParameters>
{
    ...
    public OCMethodReferencesSearch(final boolean myFindAllPotentialCalls) {
    ...
    public boolean execute(@NotNull final ReferencesSearch.SearchParameters searchParameters, @NotNull final Processor<PsiReference> processor) {
        try {
            if (searchParameters == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "queryParameters", "com/jetbrains/cidr/lang/search/OCMethodReferencesSearch", "execute"));
            }
        }
        ...
        try {
            if (processor == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "consumer", "com/jetbrains/cidr/lang/search/OCMethodReferencesSearch", "execute"));
            }
        }
        ...
        return (boolean)new ReadAction<Boolean>() {
            protected void run(@NotNull final Result<Boolean> result) {
                ...
                result.setResult((Object)OCMethodReferencesSearch.this.a(searchParameters, processor));
            }
    ...
    private Boolean a(final ReferencesSearch.SearchParameters searchParameters, final Processor<PsiReference> processor) {
        ...
        try {
            if (!(elementToSearch instanceof OCMethod)) {
                return true;
            }
        }
        catch (IllegalArgumentException ex) {
        ...
        final OCMethod ocMethod = (OCMethod)elementToSearch;
        final List<OCMethodSelectorPart> parameters = ocMethod.getParameters();
        ...
        final String selectorPart = parameters.get(0).getSelectorPart();
        try {
        ...
        Label_0139: {
            try {
                if (selectorPart.endsWith(":")) {
                    substring = selectorPart.substring(0, selectorPart.length() - 1);
                    break Label_0139;
                }
            }
        ...
        try {
            if (!instance.processElementsWithWord((TextOccurenceProcessor)new MyOccurenceProcessor(ocMethod, selector, processor, false, this.myFindAllPotentialCalls), searchParameters.getEffectiveSearchScope(), s, (short)1, true)) {
                return false;
            }
        }
        ...
        final String objCGetterFromSetter = OCNameSuggester.getObjCGetterFromSetter(selector);
        Label_0229: {
            try {
                if (objCGetterFromSetter == null) {
                    return true;
                }
                final String s2 = objCGetterFromSetter;
            ...
            try {
                ...
                final boolean b = s2.isEmpty();
                if (!b) {
                    return instance.processElementsWithWord((TextOccurenceProcessor)new MyOccurenceProcessor(ocMethod, objCGetterFromSetter, processor, true, this.myFindAllPotentialCalls), searchParameters.getEffectiveSearchScope(), objCGetterFromSetter, (short)1, true);
                }
            }
