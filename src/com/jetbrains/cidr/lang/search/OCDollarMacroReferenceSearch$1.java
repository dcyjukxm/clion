...
class OCDollarMacroReferenceSearch$1 extends ReadAction<Boolean> {
    ...
    protected void run(@NotNull final Result<Boolean> result) {
        ...
        result.setResult((Object)OCDollarMacroReferenceSearch.access$000(this.val$queryParameters, this.val$consumer));
    }
