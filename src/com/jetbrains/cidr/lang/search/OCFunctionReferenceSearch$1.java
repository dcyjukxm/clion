...
class OCFunctionReferenceSearch$1 extends ReadAction<Boolean> {
    ...
    protected void run(@NotNull final Result<Boolean> result) {
        ...
        result.setResult((Object)OCFunctionReferenceSearch.access$000(OCFunctionReferenceSearch.this, this.val$queryParameters, this.val$consumer));
    }
