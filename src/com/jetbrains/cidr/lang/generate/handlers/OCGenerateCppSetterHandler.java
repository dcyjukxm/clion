...
public class OCGenerateCppSetterHandler extends OCGenerateCppGetterSetterHandlerBase
{
    @Override
    ...
    protected OCGenerateGetterSetterContext evaluateActionContext(final OCStructSymbol ocStructSymbol, final PsiElement psiElement) {
        return new OCGenerateGetterSetterContext(ocStructSymbol, psiElement, OCGenerateGetterSetterContext.Mode.SETTER);
    }
}
