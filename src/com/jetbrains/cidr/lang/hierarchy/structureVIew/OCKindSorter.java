...
public class OCKindSorter implements Sorter
{
    ...
    public ActionPresentation getPresentation() {
        ...
        try {
            actionPresentationData = new ActionPresentationData(IdeBundle.message("action.sort.by.type", new Object[0]), "", AllIcons.ObjectBrowser.SortByType);
            if (actionPresentationData == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/lang/hierarchy/structureVIew/OCKindSorter", "getPresentation"));
            }
        }
    ...
    public String getName() {
        ...
        try {
            s = "KIND";
            if (s == null) {
                throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/jetbrains/cidr/lang/hierarchy/structureVIew/OCKindSorter", "getName"));
            }
        }
        catch (IllegalStateException ex) {
            throw a(ex);
    ...
    static {
        INSTANCE = (Sorter)new OCKindSorter();
    }
