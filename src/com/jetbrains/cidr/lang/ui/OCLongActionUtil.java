...
public class OCLongActionUtil
{
    ...
    public static boolean ourAutoCancelLongAction;
    
    public static void setAutoCancelLongAction(final boolean ourAutoCancelLongAction) {
        OCLongActionUtil.ourAutoCancelLongAction = ourAutoCancelLongAction;
    }
    
    private static int a(@NotNull final String s) {
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "timeoutPropertyName", "com/jetbrains/cidr/lang/ui/OCLongActionUtil", "getTimeoutInMs"));
            }
        }
        catch (Throwable t) {
            throw a(t);
        ...
        try {
            return Integer.parseInt(System.getProperty(s, String.valueOf(5000)));
        }
        catch (Throwable t2) {
            return 5000;
        }
    ...
    @Nullable
    public static <T> T execWithTimeoutProgressInDispatch(@NotNull final String s, @NotNull final String s2, @Nullable final Project project, final Computable<T> computable) {
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "descriptorIdForIndicator", "com/jetbrains/cidr/lang/ui/OCLongActionUtil", "execWithTimeoutProgressInDispatch"));
            }
        }
        ...
        try {
            if (s2 == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "timeoutPropertyName", "com/jetbrains/cidr/lang/ui/OCLongActionUtil", "execWithTimeoutProgressInDispatch"));
            }
        }
        ...
        if (ApplicationManager.getApplication().isDispatchThread()) {
            final ProgressIndicator a = a(s, s2, project);
            try {
                if (a != null) {
                    final ProgressManager progressManager = ProgressManager.getInstance();
                    final Computable<T> computable2 = computable;
                    final ProgressIndicator progressIndicator = a;
                    final Object o = progressManager.runProcess((Computable)computable2, progressIndicator);
                    return (T)o;
                }
            ...
            try {
                ...
                try {
                    if (a.isCanceled()) {
                        OCLog.LOG.warn(s, new Throwable((Throwable)ex4));
                    }
                }
    ...
    @Nullable
    private static ProgressIndicator a(@NotNull final String s, @NotNull final String s2, @Nullable final Project project) {
        try {
            if (s == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "descriptorIdForIndicator", "com/jetbrains/cidr/lang/ui/OCLongActionUtil", "installTimeoutIndicatorIfNeed"));
            }
        }
        catch (ProcessCanceledException ex) {
            throw a((Throwable)ex);
        ...
        try {
            if (s2 == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "timeoutPropertyName", "com/jetbrains/cidr/lang/ui/OCLongActionUtil", "installTimeoutIndicatorIfNeed"));
            }
        }
        catch (ProcessCanceledException ex2) {
            throw a((Throwable)ex2);
        ...
        return (ProgressIndicator)new WatchDogIndicator(a(s2), project, s);
    }
    
    static {
        OCLongActionUtil.ourAutoCancelLongAction = false;
    }
