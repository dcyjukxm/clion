...
public class OCExpectedTypeUtil
{
    public static Collection<OCType> getExpectedTypes(final OCExpression ocExpression, final boolean b) {
        return getExpectedTypes(ocExpression, b, new OCResolveContext((PsiElement)ocExpression));
    }
    
    public static Collection<OCType> getExpectedTypes(OCExpression ocExpression, final boolean b, @NotNull final OCResolveContext ocResolveContext) {
        try {
            if (ocResolveContext == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "context", "com/jetbrains/cidr/lang/util/OCExpectedTypeUtil", "getExpectedTypes"));
            }
        }
        ...
        for (psiElement = ocExpression.getParent(); psiElement instanceof OCParenthesizedExpression; psiElement = psiElement.getParent()) {
            ocExpression = (OCExpression)psiElement;
        }
        final MyParentVisitor myParentVisitor = new MyParentVisitor(ocExpression, b, ocResolveContext);
        psiElement.accept((PsiElementVisitor)myParentVisitor);
        return myParentVisitor.myTypesList;
    }
    
    public static OCType getExpectedType(final OCExpression ocExpression, final boolean b) {
        return (OCType)ContainerUtil.getFirstItem((Collection)getExpectedTypes(ocExpression, b), (Object)OCUnknownType.INSTANCE);
    }
    
    public static OCType getExpectedType(final OCExpression ocExpression) {
        return getExpectedType(ocExpression, false);
    }
    
    public static OCType getExpressionType(@NotNull final OCExpression ocExpression, final boolean b) {
        try {
            if (ocExpression == null) {
                throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "expression", "com/jetbrains/cidr/lang/util/OCExpectedTypeUtil", "getExpressionType"));
            }
        }
        catch (IllegalArgumentException ex) {
            throw a(ex);
        }
        return getExpressionType(ocExpression, ocExpression.getResolvedType().getGuessedType(), b);
    }
    
    public static OCType getExpressionType(@Nullable final OCExpression p0, final OCType p1, final boolean p2) {
        // 
        ...
        //     5: ifnonnull       21
        //     8: goto            15
        //    11: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //    14: athrow         
        //    15: aload_1        
        //    16: areturn        
        //    17: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //    20: athrow         
        //    21: aload_0        
        //    22: invokeinterface com/jetbrains/cidr/lang/psi/OCExpression.getProject:()Lcom/intellij/openapi/project/Project;
        //    27: invokestatic    com/intellij/psi/codeStyle/CodeStyleSettingsManager.getSettings:(Lcom/intellij/openapi/project/Project;)Lcom/intellij/psi/codeStyle/CodeStyleSettings;
        //    30: ldc             Lcom/jetbrains/cidr/lang/settings/OCCodeStyleSettings;.class
        //    32: invokevirtual   com/intellij/psi/codeStyle/CodeStyleSettings.getCustomSettings:(Ljava/lang/Class;)Lcom/intellij/psi/codeStyle/CustomCodeStyleSettings;
        //    35: checkcast       Lcom/jetbrains/cidr/lang/settings/OCCodeStyleSettings;
        //    38: astore_3       
        //    39: getstatic       com/jetbrains/cidr/lang/types/OCIntType.INT:Lcom/jetbrains/cidr/lang/types/OCIntType;
        //    42: aload_1        
        //    43: aload_0        
        //    44: invokevirtual   com/jetbrains/cidr/lang/types/OCIntType.equals:(Ljava/lang/Object;Lcom/intellij/psi/PsiElement;)Z
        //    47: ifne            104
        //    50: aload_1        
        //    51: instanceof      Lcom/jetbrains/cidr/lang/types/OCIntType;
        //    54: ifeq            112
        //    57: goto            64
        //    60: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //    63: athrow         
        //    64: aload_1        
        //    65: checkcast       Lcom/jetbrains/cidr/lang/types/OCIntType;
        //    68: aload_0        
        //    69: invokevirtual   com/jetbrains/cidr/lang/types/OCIntType.getRank:(Lcom/intellij/psi/PsiElement;)I
        //    72: getstatic       com/jetbrains/cidr/lang/types/OCIntType.INT:Lcom/jetbrains/cidr/lang/types/OCIntType;
        //    75: aload_0        
        //    76: invokevirtual   com/jetbrains/cidr/lang/types/OCIntType.getRank:(Lcom/intellij/psi/PsiElement;)I
        //    79: if_icmpge       112
        //    82: goto            89
        //    85: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //    88: athrow         
        //    89: aload_1        
        //    90: aload_0        
        //    91: invokestatic    com/jetbrains/cidr/lang/types/OCIntType.isBool:(Lcom/jetbrains/cidr/lang/types/OCType;Lcom/intellij/psi/PsiElement;)Z
        //    94: ifne            112
        //    97: goto            104
        //   100: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   103: athrow         
        //   104: iconst_1       
        //   105: goto            113
        //   108: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   111: athrow         
        //   112: iconst_0       
        //   113: istore          4
        //   115: aload_0        
        //   116: instanceof      Lcom/jetbrains/cidr/lang/psi/OCLiteralExpression;
        //   119: ifeq            235
        //   122: aload_0        
        //   123: invokeinterface com/jetbrains/cidr/lang/psi/OCExpression.getNode:()Lcom/intellij/lang/ASTNode;
        //   128: invokeinterface com/intellij/lang/ASTNode.getFirstChildNode:()Lcom/intellij/lang/ASTNode;
        //   133: invokestatic    com/jetbrains/cidr/lang/util/OCElementUtil.getElementType:(Lcom/intellij/lang/ASTNode;)Lcom/intellij/psi/tree/IElementType;
        //   136: astore          5
        //   138: aload           5
        //   140: getstatic       com/jetbrains/cidr/lang/parser/OCTokenTypes.INTEGER_LITERAL:Lcom/jetbrains/cidr/lang/parser/OCElementType;
        //   143: if_acmpne       194
        //   146: iload           4
        //   148: ifeq            194
        //   151: goto            158
        //   154: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   157: athrow         
        //   158: aload_3        
        //   159: getfield        com/jetbrains/cidr/lang/settings/OCCodeStyleSettings.INTRODUCE_USE_NS_TYPES:Z
        //   162: ifeq            190
        //   165: goto            172
        //   168: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   171: athrow         
        //   172: ldc             "NSInteger"
        //   174: aload_0        
        //   175: invokeinterface com/jetbrains/cidr/lang/psi/OCExpression.getContainingFile:()Lcom/intellij/psi/PsiFile;
        //   180: invokestatic    com/jetbrains/cidr/lang/types/OCReferenceType.resolvedFromText:(Ljava/lang/String;Lcom/intellij/psi/PsiFile;)Lcom/jetbrains/cidr/lang/types/OCType;
        //   183: goto            193
        //   186: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   189: athrow         
        //   190: getstatic       com/jetbrains/cidr/lang/types/OCIntType.INT:Lcom/jetbrains/cidr/lang/types/OCIntType;
        //   193: areturn        
        //   194: aload           5
        //   196: getstatic       com/jetbrains/cidr/lang/parser/OCTokenTypes.FLOAT_LITERAL:Lcom/jetbrains/cidr/lang/parser/OCElementType;
        //   199: if_acmpne       232
        //   202: aload_3        
        //   203: getfield        com/jetbrains/cidr/lang/settings/OCCodeStyleSettings.INTRODUCE_USE_NS_TYPES:Z
        //   206: ifeq            232
        //   209: goto            216
        //   212: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   215: athrow         
        //   216: ldc             "CGFloat"
        //   218: aload_0        
        //   219: invokeinterface com/jetbrains/cidr/lang/psi/OCExpression.getContainingFile:()Lcom/intellij/psi/PsiFile;
        //   224: invokestatic    com/jetbrains/cidr/lang/types/OCReferenceType.resolvedFromText:(Ljava/lang/String;Lcom/intellij/psi/PsiFile;)Lcom/jetbrains/cidr/lang/types/OCType;
        //   227: areturn        
        //   228: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   231: athrow         
        //   232: goto            290
        //   235: iload           4
        //   237: ifeq            290
        //   240: aload_0        
        //   241: invokestatic    com/jetbrains/cidr/lang/util/OCExpressionEvaluator.evaluate:(Lcom/jetbrains/cidr/lang/psi/OCExpression;)Ljava/lang/Number;
        //   244: ifnull          290
        //   247: goto            254
        //   250: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   253: athrow         
        //   254: aload_3        
        //   255: getfield        com/jetbrains/cidr/lang/settings/OCCodeStyleSettings.INTRODUCE_USE_NS_TYPES:Z
        //   258: ifeq            286
        //   261: goto            268
        //   264: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   267: athrow         
        //   268: ldc             "NSInteger"
        //   270: aload_0        
        //   271: invokeinterface com/jetbrains/cidr/lang/psi/OCExpression.getContainingFile:()Lcom/intellij/psi/PsiFile;
        //   276: invokestatic    com/jetbrains/cidr/lang/types/OCReferenceType.resolvedFromText:(Ljava/lang/String;Lcom/intellij/psi/PsiFile;)Lcom/jetbrains/cidr/lang/types/OCType;
        //   279: goto            289
        //   282: invokestatic    com/jetbrains/cidr/lang/util/OCExpectedTypeUtil.a:(Ljava/lang/IllegalArgumentException;)Ljava/lang/IllegalArgumentException;
        //   285: athrow         
        //   286: getstatic       com/jetbrains/cidr/lang/types/OCIntType.INT:Lcom/jetbrains/cidr/lang/types/OCIntType;
        //   289: areturn        
        //   290: aload_1        
        //   291: areturn        
        //    Exceptions:
        ...
        //  39     57     60     64     Ljava/lang/IllegalArgumentException;
        //  50     82     85     89     Ljava/lang/IllegalArgumentException;
        //  64     97     100    104    Ljava/lang/IllegalArgumentException;
        //  89     108    108    112    Ljava/lang/IllegalArgumentException;
        //  138    151    154    158    Ljava/lang/IllegalArgumentException;
        //  146    165    168    172    Ljava/lang/IllegalArgumentException;
        //  158    186    186    190    Ljava/lang/IllegalArgumentException;
        //  194    209    212    216    Ljava/lang/IllegalArgumentException;
        //  202    228    228    232    Ljava/lang/IllegalArgumentException;
        //  235    247    250    254    Ljava/lang/IllegalArgumentException;
        //  240    261    264    268    Ljava/lang/IllegalArgumentException;
        //  254    282    282    286    Ljava/lang/IllegalArgumentException;
        // 
    ...
    public static OCType getReturnTypeOfBlock(@Nullable final OCBlockStatement ocBlockStatement) {
        try {
        ...
        try {
            ocBlockStatement.accept((PsiElementVisitor)new OCRecursiveVisitor() {
                @Override
                ...
                public void visitReturnStatement(final OCReturnStatement ocReturnStatement) {
                    ...
                    if (resolvedType.getTerminalType().isUnknown()) {
                        ref.set((Object)OCUnknownType.INSTANCE);
                        return;
                    }
                    if (ref.isNull()) {
                        ref.set((Object)resolvedType);
                    }
                    else {
                        ref.set((Object)((OCType)ref.get()).getLeastCommonType(resolvedType, (PsiElement)ocReturnStatement));
                    }
                }
            });
            if (ref.isNull()) {
