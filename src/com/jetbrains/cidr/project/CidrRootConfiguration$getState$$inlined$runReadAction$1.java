...
public static final class CidrRootConfiguration$getState$$inlined$runReadAction$1<T> implements Computable<T> {
    public final T compute() {
        final CidrRootConfiguration.State access$getMyState$p = CidrRootConfiguration.access$getMyState$p(this.this$0);
